...
<html id="sitetop" lang="en-US" class="attop">
    ...
    <head>
        ...
        <title>SMS Terms | <?php echo $row['name']; ?></title>
        ...
        <meta property="og:title" content="SMS Terms | <?php echo $row['name']; ?>" />
        <meta property="og:description" content="Last Modified: January 18, 2023" />
        <meta property="og:url" content="index.php" />
        <meta property="og:site_name" content="<?php echo $row['name']; ?>" />
        <meta property="article:modified_time" content="2023-02-24T17:46:38+00:00" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "<?php echo $row['url']; ?>sms-terms/",
                "url": "<?php echo $row['url']; ?>sms-terms/",
                "name": "SMS Terms | <?php echo $row['name']; ?>",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>#website"
                },
                "datePublished": "2023-02-24T17:46:37+00:00",
                "dateModified": "2023-02-24T17:46:38+00:00",
                "breadcrumb": {
                    "@id": "<?php echo $row['url']; ?>sms-terms/#breadcrumb"
                },
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["<?php echo $row['url']; ?>sms-terms/"]
                }]
            }, {
                "@type": "BreadcrumbList",
                "@id": "<?php echo $row['url']; ?>sms-terms/#breadcrumb",
        ...
        <link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/3343.json" />
        <link rel='shortlink' href='../index4601.php?p=3343' />
        <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed"
            href="../wp-json/oembed/1.0/embedd5e5.json?url=<?php echo $row['url']; ?>sms-terms%2F" />
        <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed"
            href="../wp-json/oembed/1.0/embed8989?url=<?php echo $row['url']; ?>sms-terms%2F&amp;format=xml" />
                                    ...
                                    <ul id="header-nav" class="m-0">
                                        ...
                                        <li itemscope="itemscope"
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li class="menu-item nav-item lang-item"><a href="index.php"
...
<li itemscope="itemscope"
        ...
        <section id="page-content-container" class="is-page">
            ...
            <section id="block_76fc5b54bd7ceda59f819a564982e4f2"
            ...
            <p class="has-text-align-center">Last Modified: January 18, 2023</p>


            <section id="block_df2f46125e2be91a29fd4c394b179acb"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="achieve-text">
                                    <h2><?php echo $row['name']; ?> Informational and Transactional Communications</h2>
                                    ...
                                    <ol>
                                        <li style="list-style-type: none;">
                                            <ol>
                                                ...
                                                <li style="text-align: left;"><?php echo $row['name']; ?> (“<?php echo $row['name']; ?>”) sends text
                                                    messages related to your requests for information, the application
                                                    process, loan documentation, loan status, payment reminders, and
                                                    other services that <?php echo $row['name']; ?> provides such as tax
                                                    form completion,
                                                    filing, and submission, and other services you may request. By
                                                    Opting-In you agree to receive account related text messages sent by
                                                    an autodialer or other automated platform from
                                                    <?php echo $row['name']; ?>.</li>
                                                <li style="text-align: left;"><a>You can cancel the SMS service at any
                                                        time. </a>Just text “<strong>STOP</strong>” to the number from
                                                    which you received the text. After you send the SMS message
                                                    “<strong>STOP</strong>” to us, we will send you an SMS message to
                                                    confirm that you have been unsubscribed. After this, you will no
                                                    ...
                                                    messages to you again.</li>
                                                <li style="text-align: left;">If you are experiencing issues with the
                                                    messaging program you can reply with the keyword
                                                    <strong>HELP</strong> for more assistance, or you can get help from
                                                    <?php echo $row['name']; ?> at 210-961-7298 or email us at <a
                                                        href="../cdn-cgi/l/email-protection.php" class="__cf_email__"
                                                        data-cfemail="1e736771707277707b6d6b6e6e716c6a5e6d6b7072717f70307d7173"> <?php echo $row['email']; ?></a>.
                                                </li>
                                                <li style="text-align: left;">You agree to provide us with a valid
                                                    mobile number. Neither <?php echo $row['name']; ?> nor carriers
                                                    supporting SMS services
                                                    are liable for delayed or undelivered messages.</li>
                                                <li style="text-align: left;"><?php echo $row['name']; ?> does not charge for SMS messages;
                                                    however, SMS message data rates may apply to any messages sent to
                                                    you or messages you send to us. You may receive a text update about
                                                    your account up to five times per month. If you have any questions
                                                    about your text plan or data plan, it is best to contact your
                                                    wireless provider.</li>
                                                <li style="text-align: left;">If you have any questions regarding
                                                    privacy, please read our <a
                                                        href="../privacy-policy/index.php"><?php echo $row['url']; ?>privacy-policy/</a>
                                                </li>
                                            </ol>
                                        </li>
                                    </ol>
            ...
            <section id="block_2286b9a6251bdb5ee5b3c6cd6cd6465c"
                class="block-text alignwide block-title-bar has-font-color text-default">
                <div class="achieve-area achieve-consolidation noline ">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="achieve-text">
                                    <h2><?php echo $row['name']; ?> Advertising Communications</h2>
                                    <p>
                                    ...
                                    <ol start="1" type="1">
                                        <li style="list-style-type: none;">
                                            <ol start="1" type="1">
                                                ...
                                                <li style="text-align: left;"><?php echo $row['name']; ?> (“<?php echo $row['name']; ?>”) sends text
                                                    messages related to loan opportunities, other promotional offers,
                                                    new services, as well as financial education information. By
                                                    Opting-In to receive advertising text notifications from
                                                    <?php echo $row['name']; ?>
                                                    you agree to receive text information sent by an autodialer or other
                                                    automated platform about loan products, opportunities, and other
                                                    related information.</li>
                                                <li style="text-align: left;">You can cancel the SMS service at any
                                                    time. Just text “<strong>STOP</strong>” to the short code. After you
                                                    send the SMS message “<strong>STOP</strong>” to us, we will send you
                                                    an SMS message to confirm that you have been unsubscribed. After
                                                    this, you will no longer receive SMS messages from us. If you want
                                                    to join again, just sign up as you did the first time, and we will
                                                    start sending SMS messages to you again.</li>
                                                <li style="text-align: left;">If you are experiencing issues with the
                                                    messaging program you can reply with the keyword
                                                    <strong>HELP</strong> for more assistance, or you can get help from
                                                    <?php echo $row['name']; ?> at 210-961-7298 or email us at <a
                                                        href="../cdn-cgi/l/email-protection.php" class="__cf_email__"
                                                        data-cfemail="e38e9a8c8d8f8a8d86909693938c9197a390968d8f8c828dcd808c8e"> <?php echo $row['email']; ?></a>.
                                                </li>
                                                <li style="text-align: left;">You agree to provide us with a valid
                                                    mobile number. Neither <?php echo $row['name']; ?> nor carriers
                                                    supporting SMS services
                                                ...
                                                <li style="text-align: left;"><?php echo $row['name']; ?> does not charge for SMS messages;
                                                    however, SMS message data rates may apply to any messages sent to
                                                    you or messages you send to us. You may receive text messages about
                                                    our loan products, opportunities, and other related information
                                                    about three times per month. If you have any questions about your
                                                    text plan or data plan, it is best to contact your wireless
                                                    provider.If you have any questions regarding privacy, please read
                                                    our <a
                                                        href="../privacy-policy/index.php"><?php echo $row['url']; ?>privacy-policy/</a>
                                                </li>
                                            </ol>
                                ...
                                <div class="widget footer-nav footer-widget-2 widget_nav_menu nav_menu-3">
                                    ...
                                    <div class="menu-footer-column-2-container">
                                        <ul id="menu-footer-column-2" class="menu">
                                            ...
                                            <li id="menu-item-3550" class="menu-item current-menu-item"><a
                                                    href="index.php" aria-current="page">SMS Terms</a></li>
                                        </ul>
                                    </div>
                                </div>
