...
<html id="sitetop" lang="en-US" class="attop">
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/contact/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Dec 2024 23:45:18 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <link rel="alternate" hreflang="es" href="../es/contacto/index.php" />
        ...
        <title>Contact Us | <?php echo $row['name']; ?>®</title>
        ...
        <meta name="description"
            content="If you have questions or want to request more information about your loan, call <?php echo $row['name']; ?> at <?php echo $row['phone']; ?>." />
        <link rel="canonical" href="index.php" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Contact Us | <?php echo $row['name']; ?>®" />
        <meta property="og:description"
            content="If you have questions or want to request more information about your loan, call <?php echo $row['name']; ?> at <?php echo $row['phone']; ?>." />
        <meta property="og:url" content="index.php" />
        <meta property="og:site_name" content="<?php echo $row['name']; ?>" />
        <meta property="article:modified_time" content="2022-05-30T23:11:58+00:00" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                ...
                "name": "Contact Us | <?php echo $row['name']; ?>®",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>#website"
                },
                "datePublished": "2022-04-27T06:30:02+00:00",
                "dateModified": "2022-05-30T23:11:58+00:00",
                "description": "If you have questions or want to request more information about your loan, call <?php echo $row['name']; ?> at <?php echo $row['phone']; ?>.",
                "breadcrumb": {
                    "@id": "<?php echo $row['url']; ?>contact/#breadcrumb"
                },
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
        ...
        <link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/1508.json" />
        <link rel='shortlink' href='../index99b7.php?p=1508' />
        <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed"
            href="../wp-json/oembed/1.0/embed6a83.json?url=<?php echo $row['url']; ?>contact%2F" />
        <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed"
            href="../wp-json/oembed/1.0/embed07b5?url=<?php echo $row['url']; ?>contact%2F&amp;format=xml" />
    ...
    <body>
                                            ...
                                            <li itemscope="itemscope"
                                                ...
                                                <ul class="wpml-ls-sub-menu dropdown-menu">
                                                    ...
                                                    <li itemscope="itemscope"
                                                        ...
                                                        <a href="../es/contacto/index.php" class="wpml-ls-link">
                                ...
                                <div class="mainmenu" id="mainmenu">
                                    <ul id="header-nav" class="m-0">
                                        <li itemscope="itemscope"
                                            ...
                                            <a title="Contact Us" href="index.php" class="nav-link"></a>
                                        </li>
                                        <li itemscope="itemscope"
                                            itemtype="https://www.schema.org/SiteNavigationElement"
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li class="menu-item nav-item lang-item"><a
                                                        href="../es/contacto/index.php" class="lang-link">Spanish</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li itemscope="itemscope"
        ...
        <section id="page-content-container" class="is-page">
            ...
            <section id="block_6268f2579c493"
            ...
            <section
                class="wp-block-group alignwide cs_section mx_800 bgr_color is-content-justification-left is-layout-flex wp-container-core-group-is-layout-1 wp-block-group-is-layout-flex"
                id="contact-content">
                <div
                    ...
                    <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow" style="flex-basis:100%">
                        <h2 class="title-area has-blue-color has-text-color wp-block-heading" style="font-size:22px">
                            Disputes, Comments or Complaints</h2>



                        <p style="font-size:20px">If you wish to contact an agent directly, <strong>please contact
                                us</strong> at:</p>
                        ...
                        <p style="font-size:20px"><strong>For all other comments and complaints, please complete the
                                form below.</strong></p>
                    </div>
                </div>
            </section>
            ...
            <!--<section id="block_6268fb0083d31" class="block-form  alignfull block-form has-font-color text-default">
	                    ...
	                    jQuery(this).css("opacity", 0.2).data("isclicked", true);
                                ...
                                <div class='gf_browser_chrome gform_wrapper gravity-theme gform-theme--no-framework'
                                    ...
                                    <form method='post' enctype='multipart/form-data' target='gform_ajax_frame_1'
                                        id='gform_1' action='<?php echo $row['url']; ?>contact/#gf_1' data-formid='1'
                                        novalidate>
                                        <div class='gform-body gform_body'>
                                            <div id='gform_fields_1'
                                                class='gform_fields top_label form_sublabel_below description_below validation_below'>
                                                <div id="field_1_1"
                                                    class="gfield gfield--type-select gfield--input-type-select gfield--width-full gfield_contains_required field_sublabel_below gfield--no-description field_description_below field_validation_below gfield_visibility_visible"
                                                    data-js-reload="field_1_1"><label
                                                        class='gfield_label gform-field-label' for='input_1_1'>Do you
                                                        currently have a personal installment loan from
                                                        <?php echo $row['name']; ?>?<span class="gfield_required"><span
                                                    ...
                                                    <div class='ginput_container ginput_container_select'><select
                                                            name='input_1' id='input_1_1' class='medium gfield_select'
                                                ...
                                                <div id="field_1_14"
                                                    ...
                                                    data-js-reload="field_1_14"><label
                                                        class='gfield_label gform-field-label' for='input_1_14'>Select
                                                        <?php echo $row['name']; ?> location<span
                                                            class="gfield_required"><span
                                                                class="gfield_required gfield_required_text">(Required)</span></span></label>
                                                    <div class='ginput_container ginput_container_text'><input
                                                            name='input_14' id='input_1_14' type='text' value=''
                                                            class='medium'
                                                            placeholder='ex: <?php echo $row['name']; ?> Office Las Palmas'
                                                            aria-required="true" aria-invalid="false" /></div>
                                                </div>
                                                <fieldset id="field_1_4"
                                                    class="gfield gfield--type-name gfield--input-type-name gfield--width-half field_sublabel_hidden_label gfield--no-description field_description_below field_validation_below gfield_visibility_visible"
                                                    data-js-reload="field_1_4">
                                                    <legend
                                                        class='gfield_label gform-field-label gfield_label_before_complex'>
                                                        First Name</legend>
                                                    <div class='ginput_complex ginput_container ginput_container--name no_prefix has_first_name no_middle_name no_last_name no_suffix gf_name_has_1 ginput_container_name gform-grid-row'
                                                        id='input_1_4'>

                                                        <span id='input_1_4_3_container'
                                                            class='name_first gform-grid-col gform-grid-col--size-auto'>
                                                            <input type='text' name='input_4.3' id='input_1_4_3'
                                                ...
                                                <fieldset id="field_1_5"
                                                    ...
                                                    <div class='ginput_complex ginput_container ginput_container--name no_prefix has_first_name no_middle_name no_last_name no_suffix gf_name_has_1 ginput_container_name gform-grid-row'
                                                        ...
                                                        <span id='input_1_5_3_container'
                                                            class='name_first gform-grid-col gform-grid-col--size-auto'>
                                                            <input type='text' name='input_5.3' id='input_1_5_3'
                                                                value='' aria-required='false' />
                                                            <label for='input_1_5_3'
                                                                class='gform-field-label gform-field-label--type-sub hidden_sub_label screen-reader-text'>First</label>
                                                        </span>
                                                ...
                                                <div id="field_1_6"
                                                    ...
                                                    data-js-reload="field_1_6"><label
                                                        class='gfield_label gform-field-label' for='input_1_6'>Email
                                                        Address<span class="gfield_required"><span
                                                                class="gfield_required gfield_required_text">(Required)</span></span></label>
                                                    <div class='ginput_container ginput_container_email'>
                                                        <input name='input_6' id='input_1_6' type='email' value=''
                                                            class='large' aria-required="true" aria-invalid="false" />
                                                    </div>
                                                </div>
                                                <div id="field_1_7"
                                                    class="gfield gfield--type-phone gfield--input-type-phone gfield--width-half gfield_contains_required field_sublabel_below gfield--no-description field_description_below field_validation_below gfield_visibility_visible"
                                                    data-js-reload="field_1_7"><label
                                                        class='gfield_label gform-field-label' for='input_1_7'>Phone
                                                        Number<span class="gfield_required"><span
                                                                class="gfield_required gfield_required_text">(Required)</span></span></label>
                                                    <div class='ginput_container ginput_container_phone'><input
                                                            name='input_7' id='input_1_7' type='tel' value=''
                                                            class='large' aria-required="true" aria-invalid="false" />
                                                    </div>
                                                </div>
                                                <div id="field_1_9"
                                                    ...
                                                    data-js-reload="field_1_9"><label
                                                        class='gfield_label gform-field-label' for='input_1_9'>Zip
                                                        Code<span class="gfield_required"><span
                                                                class="gfield_required gfield_required_text">(Required)</span></span></label>
                                                    <div class='ginput_container ginput_container_text'><input
                                                ...
                                                <div id="field_1_10"
                                                    class="gfield gfield--type-select gfield--input-type-select gfield--width-half widthfull gfield_contains_required field_sublabel_below gfield--no-description field_description_below field_validation_below gfield_visibility_visible"
                                                    data-js-reload="field_1_10"><label
                                                        class='gfield_label gform-field-label'
                                                        for='input_1_10'>State<span class="gfield_required"><span
                                                                class="gfield_required gfield_required_text">(Required)</span></span></label>
                                                    <div class='ginput_container ginput_container_select'><select
                                                            name='input_10' id='input_1_10' class='large gfield_select'
                                                            aria-required="true" aria-invalid="false">
                                                            <option value='' selected='selected' class='gf_placeholder'>
                                                ...
                                                <div id="field_1_3"
                                                    class="gfield gfield--type-select gfield--input-type-select gfield--width-full widthfull gfield_contains_required field_sublabel_below gfield--no-description field_description_below field_validation_below gfield_visibility_visible"
                                                    data-js-reload="field_1_3"><label
                                                        class='gfield_label gform-field-label' for='input_1_3'>What is
                                                        the general topic of your inquiry?<span
                                                            class="gfield_required"><span
                                                                class="gfield_required gfield_required_text">(Required)</span></span></label>
                                                    <div class='ginput_container ginput_container_select'><select
                                                            name='input_3' id='input_1_3' class='large gfield_select'
                                                            aria-required="true" aria-invalid="false">
                                                            <option value='General comment or question'>General comment
                                                                or question</option>
                                                            <option value='Concern'>Concern</option>
                                                            <option value='Loan product questions'>Loan product
                                                                questions</option>
                                                            <option value='Website feedback'>Website feedback</option>
                                                            <option value='Privacy and security'>Privacy and security
                                                            </option>
                                                            <option value='Applying for a loan'>Applying for a loan
                                                            </option>
                                                            <option value='Report suspicious email or fraud attempt'>
                                                                Report suspicious email or fraud attempt</option>
                                                        </select></div>
                                                </div>
                                                <div id="field_1_11"
                                                    ...
                                                    data-js-reload="field_1_11"><label
                                                        class='gfield_label gform-field-label'
                                                        for='input_1_11'>Comments</label>
                                                    <div class='ginput_container ginput_container_textarea'><textarea
                                                            name='input_11' id='input_1_11' class='textarea medium'
                                                ...
                                                <div id="field_1_15"
                                                    ...
                                                    data-js-reload="field_1_15"><label
                                                        class='gfield_label gform-field-label'
                                                        for='input_1_15'>CAPTCHA</label>
                                                    <div id='input_1_15' class='ginput_container ginput_recaptcha'
                                                        data-sitekey='6LeLODggAAAAAFYBglblh9GtevF3E2ANR1oFrq-o'
                                                ...
                                                <div id="field_1_12"
                                                    ...
                                                    data-js-reload="field_1_12">This site is protected by reCAPTCHA and
                                                    the Google <a href="https://policies.google.com/privacy">Privacy
                                                        Policy</a> and <a href="https://policies.google.com/terms">Terms
                                                ...
                                                <div id="field_1_13"
                                                    ...
                                                    <div class="submit-btn">
                                                        <button onclick="submitGForm();"
                                                            style="height: 2.5rem;padding:0 1rem;font-size:1rem;">
                                                            Submit
                                                        </button>
                                                    </div>
                                                </div>
                                                <div id="field_1_16"
                                                    ...
                                                    data-js-reload="field_1_16"><label
                                                        class='gfield_label gform-field-label'
                                                        for='input_1_16'>Phone</label>
                                                    <div class='ginput_container'><input name='input_16' id='input_1_16'
                                                            type='text' value='' autocomplete='new-password' /></div>
                                                    <div class='gfield_description' id='gfield_description_1_16'>This
                                        ...
                                        <div class='gform-footer gform_footer top_label'> <input type='submit'
                                                ...
                                                onclick='gform.submission.handleButtonClick(this);' value='Submit' />
                                            ...
                                            <input type='hidden' class='gform_hidden' name='gform_theme'
                                                data-js='gform_theme_1' id='gform_theme_1' value='gravity-theme' />
                                            <input type='hidden' class='gform_hidden' name='gform_style_settings'
                                                data-js='gform_style_settings_1' id='gform_style_settings_1' value='' />
                                            <input type='hidden' class='gform_hidden' name='is_submit_1' value='1' />
                                            <input type='hidden' class='gform_hidden' name='gform_submit' value='1' />

                                            <input type='hidden' class='gform_hidden' name='gform_unique_id' value='' />
                                            <input type='hidden' class='gform_hidden' name='state_1'
                                                value='WyJbXSIsImE1NzE0NTAxOTYxMWQwNTM5N2M5MzFhNjlmNmI5ZjQ4Il0=' />
            ...
            <section
                class="wp-block-group cs_section is-content-justification-left is-layout-flex wp-container-core-group-is-layout-2 wp-block-group-is-layout-flex">
                <div
                    class="wp-block-columns is-layout-flex wp-container-core-columns-is-layout-2 wp-block-columns-is-layout-flex">
                    <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow" style="flex-basis:100%">
                        <p class="has-text-align-center" style="font-size:20px"><strong>For any questions regarding your
                                loan give us a call at <span
                                    style="color: #da3c0b;"><?php echo $row['phone']; ?></span></strong></p>
                                ...
                                <div class="widget footer-nav footer-widget-1 widget_nav_menu nav_menu-2">
                                    ...
                                    <div class="menu-footer-column-1-container">
                                        <ul id="menu-footer-column-1" class="menu">
                                            ...
                                            <li id="menu-item-2992" class="menu-item current-menu-item"><a
        ...
        <script type="rocketlazyloadscript">
            gform.initializeOnLoaded( function() { jQuery(document).on('gform_post_render', function(event, formId, currentPage){if(formId == 1) {if(typeof Placeholders != 'undefined'){
                        Placeholders.enable();
                    }jQuery('#input_1_7').mask('(999) 999-9999').bind('keypress', function(e){if(e.which == 13){jQuery(this).blur();} } );(function($){$(document).on("click", ".gform_wrapper .gform_button, .gform_wrapper button", function(){  $(this).text("Processing...").attr("value", "Processing..."); $(this).closest("form").addClass("pe-none opacity-50"); });})(jQuery);} } );jQuery(document).on('gform_post_conditional_logic', function(event, formId, fields, isInit){} ) } );
</script>
        <script type="rocketlazyloadscript">
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/contact/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Dec 2024 23:45:22 GMT -->
