...
<html id="sitetop" lang="en-US" class="attop">
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/licenses-disclosures/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Dec 2024 23:47:04 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <link rel="alternate" hreflang="es" href="../es/licencias-divulgaciones/index.php" />
        ...
        <title>Licenses/Disclosures | <?php echo $row['name']; ?></title>
        ...
        <meta name="description"
            content="Read about our New Mexico Small Business License &amp; Loan and Rate Fees Disclosure here! Call us at 844-786-7100 if you have any questions." />
        <link rel="canonical" href="index.php" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Licenses/Disclosures | <?php echo $row['name']; ?>" />
        <meta property="og:description"
            content="Read about our New Mexico Small Business License &amp; Loan and Rate Fees Disclosure here! Call us at 844-786-7100 if you have any questions." />
        <meta property="og:url" content="index.php" />
        <meta property="og:site_name" content="<?php echo $row['name']; ?>" />
        <meta property="article:modified_time" content="2024-11-25T19:20:33+00:00" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "<?php echo $row['url']; ?>licenses-disclosures/",
                "url": "<?php echo $row['url']; ?>licenses-disclosures/",
                "name": "Licenses/Disclosures | <?php echo $row['name']; ?>",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>#website"
                },
                "datePublished": "2022-05-16T15:46:46+00:00",
                "dateModified": "2024-11-25T19:20:33+00:00",
                "description": "Read about our New Mexico Small Business License & Loan and Rate Fees Disclosure here! Call us at 844-786-7100 if you have any questions.",
                "breadcrumb": {
                    "@id": "<?php echo $row['url']; ?>licenses-disclosures/#breadcrumb"
                },
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["<?php echo $row['url']; ?>licenses-disclosures/"]
                }]
            }, {
                "@type": "BreadcrumbList",
                "@id": "<?php echo $row['url']; ?>licenses-disclosures/#breadcrumb",
        ...
        <link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/2059.json" />
        <link rel='shortlink' href='../index230e.php?p=2059' />
        <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed"
            href="../wp-json/oembed/1.0/embed17e0.json?url=<?php echo $row['url']; ?>licenses-disclosures%2F" />
        <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed"
            href="../wp-json/oembed/1.0/embedb837?url=<?php echo $row['url']; ?>licenses-disclosures%2F&amp;format=xml" />
                                            ...
                                            <li itemscope="itemscope"
                                                ...
                                                <ul class="wpml-ls-sub-menu dropdown-menu">
                                                    ...
                                                    <li itemscope="itemscope"
                                                        ...
                                                        <a href="../es/licencias-divulgaciones/index.php"
                                                            class="wpml-ls-link">
                                        ...
                                        <li itemscope="itemscope"
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li class="menu-item nav-item lang-item"><a
                                                        href="../es/licencias-divulgaciones/index.php"
...
<li itemscope="itemscope"
        ...
        <section id="page-content-container" class="is-page">
            ...
            <section id="block_50c8294d9378102e17b3a56a413b8fad"
                ...
                <div
                    ...
                    <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow" style="flex-basis:100%">
                        ...
                        <ul class="wp-block-list">
                            <li><a href="../wp-content/uploads/2023/03/Consumer-Information-Common-Terms-and-Definitions.pdf"
                                    target="_blank" rel="noreferrer noopener">Mandatory Consumer Information
                                    Brochure</a></li>



                            <li><a href="../wp-content/uploads/2023/08/NM-Updated-Loan-Rate-and-Fees-Disclosure.pdf"
                                    target="_blank" rel="noreferrer noopener">Loan Rate and Fees Disclosure</a></li>



                            <li><a href="../wp-content/uploads/2024/06/NM-Web-License-2024_2025.pdf" target="_blank"
                                    rel="noreferrer noopener">New Mexico Web License</a></li>
                        </ul>
                        ...
                        <h2 class="wp-block-heading">New Mexico Concerns and Complaints</h2>
                        ...
                        <p><strong><?php echo $row['name']; ?> / Compliance Dept</strong><br><?php echo $row['addr']; ?>. San Antonio, TX
                            78201<br>800-531-7652<br><a
                                href= <?php echo $row['email']; ?>"><span
                                    class="__cf_email__"
                                    data-cfemail="1e7d71706a7f7d6a5e7c6c6b707a7f797b73796a307d7173"> <?php echo $row['email']; ?></span></a>
                        </p>



                        <p>This lender is licensed and regulated by the New Mexico Regulation and Licensing Department,
                            Financial Institutions Division, P.O. Box 25101, 2550 Cerrillos Road, Santa Fe, New Mexico
                            87504.<br>To report any unresolved problems or complaints, contact the division by telephone
                            at (505) 476-4885 or visit the website <a href="https://www.rld.state.nm.us/"
                                target="_blank"
                                rel="noreferrer noopener">https://www.rld.nm.gov/financial-institutions</a></p>
                        ...
                        <ul class="wp-block-list">
                            <li><a href="../wp-content/uploads/2023/04/Missouri-Loan-Rate-Fees-Disclosure.pdf"
                                    target="_blank" rel="noreferrer noopener">Missouri Loan Rate and Fees Disclosure</a>
                            </li>



                            <li><a href="../wp-content/uploads/2024/07/MO-Web-License-2024-2025.pdf" target="_blank"
                                    rel="noreferrer noopener">Missouri Call Center License</a></li>
                        </ul>
                        ...
                        <p><strong>Regulated by the Nevada Financial Institutions Division</strong></p>



                        <p>NRS 604A.583 Required notices. A licensee who has been issued a license to operate a
                            high-interest loan service pursuant to this chapter shall place the following notices on
                            marketing materials and television, print, radio, and internet advertising when space or
                            time reasonably permits:</p>



                        <ol class="wp-block-list">
                            <li>High-interest loans should be used for short-term financial needs only and not used as a
                                long-term financial solution; and</li>



                            <li>Customers with credit difficulties should seek credit counseling before entering into
                                any high-interest loan transaction.</li>
                        </ol>
                                ...
                                <div class="widget footer-nav footer-widget-2 widget_nav_menu nav_menu-3">
                                    ...
                                    <div class="menu-footer-column-2-container">
                                        <ul id="menu-footer-column-2" class="menu">
                                            ...
                                            <li id="menu-item-2996" class="menu-item current-menu-item"><a
                                                    href="index.php" aria-current="page">Licenses/Disclosures</a></li>
        ...
        <div class="wpml-ls-statics-footer wpml-ls wpml-ls-legacy-list-horizontal">
            <ul>
                ...
                <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"
                    ...
                    <a href="../es/licencias-divulgaciones/index.php" class="wpml-ls-link">
                        <img width="18" height="12" class="wpml-ls-flag"
...
<?php echo $row['tawk']; ?>
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/licenses-disclosures/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Dec 2024 23:47:11 GMT -->
