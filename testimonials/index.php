...
<html id="sitetop" lang="en-US" class="attop">
    ...
    <head>
        ...
        <link rel="alternate" hreflang="es" href="../es/preparacion/index.php" />
        ...
        <title>Loan Payment Protection &amp; Filing Services | <?php echo $row['name']; ?>®</title>
    ...
    <body>
                                ...
                                <div class="mainmenu" id="mainmenu">
                                    <ul id="header-nav" class="m-0">
                                        ...
                                        <li itemscope="itemscope"
                                            ...
                                            class="menu-item current-menu-item active nav-item"><a title="testimonials"
                                                href="index.php" class="nav-link">Testimonials</a></li>
                                        <li itemscope="itemscope"
        ...
        <section id="page-content-container" class="is-page">
            ...
            <section id="block_6cda379ffe3af16117ddfa20bd01a0fa"
                            ...
                            <div class="testimonial_item">
                                <div class="review_card">
                                    ...
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p>I love <?php echo $row['name']; ?> and Sarah Snyder is the she always helps
                                            and makes sure my
                                            testimonials get done right. And she always has a smile on her face. So if
                                            your
                                            looking for somebody to do your testimonials or to get an loan stop by and
                                            let
                                            Sarah help you.</p>
                                        </p>
                                    </div>
                            ...
                            <div class="testimonial_item">
                                <div class="review_card">
                                    ...
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p><?php echo $row['name']; ?> been doing my testimonials over 4years. They
                                            always get me the most
                                            money
                                            back. Amazing service and always fast and so friendly. Highly recommend.</p>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="testimonial_item">
                                <div class="review_card">
                                    ...
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p>Maria and Kim and very nice and sweet and very professional. They made me
                                            feel very welcome right a away. Maria also help me do my testimonials for
                                            the first
                                            time which was fast and easy. I will be differently be coming back next year
                                            to do my testimonials again😁</p>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="testimonial_item">
                                <div class="review_card">
                                    ...
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p>Great staff!! They do testimonials and give you free estimates and will even
                                            give
                                            you an advance on your income tax so definitely hit them up!</p>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="testimonial_item">
                                <div class="review_card">
                                    ...
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p>Service is good. Fast and easy to apply. They even have service for your
                                            income tax return. Thank you <?php echo $row['name']; ?> staff for your
                                            service.</p>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="testimonial_item">
                                <div class="review_card">
                                    ...
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p>I’ve been filing my testimonials there for 5 years</p>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="testimonial_item">
                                <div class="review_card">
                                    ...
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p>Been comming here for a couple of yrs now to do my testimonials..100%
                                            recommend.Letty Gonzales is the one who does my testimonials very helpful
                                            and
                                            friendly..The other staff as well is very helpful and friendly..🥰</p>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="menu-footer-column-3-container">
                                        <ul id="menu-footer-column-3" class="menu">
                                            ...
                                            <li id="menu-item-3027" class="menu-item current-menu-item"><a
                                                    href="index.php" aria-current="page">Loan Payment Protection
                                                    Services</a>
                                            </li>
