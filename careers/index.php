...
<html id="sitetop" lang="en-US" class="attop">
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/careers/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Dec 2024 23:46:43 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <link rel="alternate" hreflang="es" href="../es/empleos/index.php" />
        ...
        <title>Career Opportunities &amp; Job Openings | <?php echo $row['name']; ?>®</title>
        ...
        <link rel="preload" data-rocket-preload as="image"
            href="../wp-content/themes/sunloan-theme/assets/images/dot-2.webp" fetchpriority="high">
        <meta name="description"
            content="A career at <?php echo $row['name']; ?> offers you competitive play, paid training, and great benefits. We take care of our people. Search for job openings near you!" />
        <link rel="canonical" href="index.php" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Career Opportunities &amp; Job Openings | <?php echo $row['name']; ?>®" />
        <meta property="og:description"
            content="A career at <?php echo $row['name']; ?> offers you competitive play, paid training, and great benefits. We take care of our people. Search for job openings near you!" />
        <meta property="og:url" content="index.php" />
        <meta property="og:site_name" content="<?php echo $row['name']; ?>" />
        <meta property="article:modified_time" content="2024-05-31T20:26:57+00:00" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "<?php echo $row['url']; ?>careers/",
                "url": "<?php echo $row['url']; ?>careers/",
                "name": "Career Opportunities & Job Openings | <?php echo $row['name']; ?>®",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>#website"
                },
                "datePublished": "2022-04-26T06:13:47+00:00",
                "dateModified": "2024-05-31T20:26:57+00:00",
                "description": "A career at <?php echo $row['name']; ?> offers you competitive play, paid training, and great benefits. We take care of our people. Search for job openings near you!",
                "breadcrumb": {
                    "@id": "<?php echo $row['url']; ?>careers/#breadcrumb"
                },
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["<?php echo $row['url']; ?>careers/"]
                }]
            }, {
                "@type": "BreadcrumbList",
                "@id": "<?php echo $row['url']; ?>careers/#breadcrumb",
        ...
        <link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/1089.json" />
        <link rel='shortlink' href='../indexf8dc.php?p=1089' />
        <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed"
            href="../wp-json/oembed/1.0/embedd834.json?url=<?php echo $row['url']; ?>careers%2F" />
        <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed"
            href="../wp-json/oembed/1.0/embedd1f2?url=<?php echo $row['url']; ?>careers%2F&amp;format=xml" />
    ...
    <body>
                                            ...
                                            <li itemscope="itemscope"
                                                ...
                                                <ul class="wpml-ls-sub-menu dropdown-menu">
                                                    ...
                                                    <li itemscope="itemscope"
                                                        ...
                                                        <a href="../es/empleos/index.php" class="wpml-ls-link">
                                        ...
                                        <li itemscope="itemscope"
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li class="menu-item nav-item lang-item"><a
                                                        href="../es/empleos/index.php" class="lang-link">Spanish</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li itemscope="itemscope"
        ...
        <section id="page-content-container" class="is-page">
            ...
            <section id="block_aa5181c9de003a38c917a8107325b544"
                class="block-hero-bar alignfull block-hero-bar has-font-color text-default">
                <div class="page-title-area blue">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
            ...
            <section id="block_83330659c528070928829592fc9eaf0f"
                class="block-text  alignfull block-title-bar has-font-color text-default">
                <div class="achieve-area achieve-consolidation noline ">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="achieve-text">
                                    <h2>
                                        <sl class="keep-arc">More than</sl> a job – a path to opportunity
                                    </h2>
                                    <p><?php echo $row['name']; ?> employees enjoy competitive benefits, truly
                                        collaborative workplaces,
                                        and the chance to give a leg up to friends and neighbors in their very own
                                        communities</p>

                                    <div class="twin-btn single-btn">
                                        <a href="../contact/index.php" target="_self"
                                            class="common-btn btn_blue">Contact us</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- <section id="block_dad8982cce3724c5760b9a1de2981422"
                class="block-multi-content  alignfull block-multi-content has-font-color text-default">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <div class="branch-thumb">
                                    <img decoding="async" width="1030" height="831"
                                        src="../wp-content/uploads/2022/04/img-5.jpg" class="" alt="img-5" id="1109"
                                        loading="lazy"
                                        srcset="<?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5.jpg 1030w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-496x400.jpg 496w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-806x650.jpg 806w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-248x200.jpg 248w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-768x620.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-980x791.jpg 980w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-600x484.jpg 600w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-744x600.jpg 744w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-400x323.jpg 400w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-150x121.jpg 150w"
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="branch-text">
                                    ...
                                    <div class="d-block d-md-none">
                                        <img fetchpriority="high" decoding="async" width="1030" height="831"
                                            src="../wp-content/uploads/2022/04/img-5.jpg" class="my-3 d-block w-100"
                                            alt="Awards"
                                            srcset="<?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5.jpg 1030w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-496x400.jpg 496w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-806x650.jpg 806w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-248x200.jpg 248w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-768x620.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-980x791.jpg 980w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-600x484.jpg 600w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-744x600.jpg 744w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-400x323.jpg 400w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-5-150x121.jpg 150w"
                                            sizes="(max-width: 1030px) 100vw, 1030px" />
                                    </div>
                                    <p>With paid on-site training, continual development opportunities, industry-related
                                        tuition reimbursement, and generous performance-based bonuses, we ensure our
                                        team members have all the tools they need to succeed in their careers and make
                                        <?php echo $row['name']; ?> their long-term home.</p>
                                    <div class="d-flex added-awards justify-content-center justify-content-md-start">
                                        <img decoding="async" width="690" height="1128"
                                            src="../wp-content/uploads/2024/05/TWP-USA_2024.png"
                                            class="aw-img aw-img-1 size-medium alignleft m-0" alt="Awards"
                                            srcset="<?php echo $row['url']; ?>/wp-content/uploads/2024/05/TWP-USA_2024.png 690w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/TWP-USA_2024-245x400.png 245w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/TWP-USA_2024-398x650.png 398w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/TWP-USA_2024-122x200.png 122w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/TWP-USA_2024-600x981.png 600w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/TWP-USA_2024-367x600.png 367w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/TWP-USA_2024-400x654.png 400w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/TWP-USA_2024-150x245.png 150w"
                                            sizes="(max-width: 690px) 100vw, 690px" />
                                        <div class="my-auto text-white h4 ps-3">An award-winning workplace</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section id="block_0cf2c438349472b251f1036620a88c8c"
                class="block-grid alignfull block-grid has-font-color text-default">
                <div class="benefits-area">
                    <div class="container">
                        <div class="row mb-5">
                            <div class="col-lg-12 text-center">
                                <div class="area-title pb-3">
                                    <h2>Here are just some of the benefits you’ll enjoy </h2>
                                </div>
                            </div>
                        </div>
                        <div class="row gridthm">

                            <div class="grid_box">
                                <div class="benefit_single ">
                                    <h4>Low deductible medical coverage, including dental and vision</h4>
                                    <p>Take care of your own and your family’s healthcare needs with insurance options
                                        that fit your budget </p>
                                </div>
                            </div>
                            <div class="grid_box">
                                <div class="benefit_single ">
                                    <h4>Performance and experience-based bonuses</h4>
                                    <p>Get rewarded for all the hard work you put in with competitive cash bonuses that
                                        incentivize great service</p>
                                </div>
                            </div>
                            <div class="grid_box">
                                <div class="benefit_single ">
                                    <h4>Disability coverage and life insurance</h4>
                                    <p>We’re in it for the long haul and want to make sure you feel covered and cared
                                        for if faced with the unexpected</p>
                                </div>
                            </div>
                            <div class="grid_box">
                                <div class="benefit_single no-border">
                                    <h4>Competitive Vacation and Sick Leave</h4>
                                    <p>With generous paid time off allowances that increase with your time at the
                                        company, we ensure you have lots of chances to relax and recharge</p>
                                </div>
                            </div>
                            <div class="grid_box">
                                <div class="benefit_single no-border">
                                    <h4>401k saving opportunities</h4>
                                    <p>Plan for your golden years with opportunities to contribute to your investment
                                        savings while lowering taxable income</p>
                                </div>
                            </div>
                            <div class="grid_box">
                                <div class="benefit_single no-border">
                                    <h4>Select tuition reimbursement</h4>
                                    <p>We’ll cover expenses for continuing education related to your core job functions,
                                        ensuring you’re equipped to get ahead</p>
                                </div>
                            </div>
            ...
            <section id="block_8d613f3b9ea45c2bb47a53fb00c6b968"
                class="block-multi-content  alignfull block-multi-content has-font-color text-default">
                        ...
                        <div class="row text-center">
                            <div class="col-lg-12 mb-5">
                                <div class="area-title">
                                    <h2>Life as a Customer Service Loan Specialist</h2>
                                    <p>We’re always in search of amazing Customer Service Loan Specialists – the
                                        in-branch professionals who help individuals in their communities reach their
                                        financial goals every day. Here’s what you can expect from a day in the life of
                                        a specialist.</p>
                                </div>
                            </div>
                        </div>
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6 order-last order-md-first">
                                <div class="specialist_text">
                                    ...
                                    <ul>
                                        <li>Providing excellent customer service and thorough education to individuals
                                            interested in personal installment loans</li>
                                        <li>Efficiently handling financial transactions to ensure borrowers get their
                                            money when they need it</li>
                                        <li>Working with borrowers who are overdue to identify solutions for repayment
                                        </li>
                                        <li>Accurately handling a cash drawer and bank deposits</li>
                                        <li>Spreading the word about personal installment loans in your local community
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 order-first order-md-last">
                                <div class="specialist_thumb">
                                    <img decoding="async" width="994" height="1082"
                                        src="../wp-content/uploads/2022/04/img-6.jpg" class="" alt="img-6" id="1336"
                                        loading="lazy"
                                        srcset="<?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-6.jpg 994w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-6-367x400.jpg 367w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-6-597x650.jpg 597w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-6-184x200.jpg 184w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-6-768x836.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-6-980x1067.jpg 980w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-6-600x653.jpg 600w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-6-551x600.jpg 551w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-6-400x435.jpg 400w, <?php echo $row['url']; ?>/wp-content/uploads/2022/04/img-6-150x163.jpg 150w"
                                        sizes="auto, (max-width: 994px) 100vw, 994px" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="block_f4a7ef46ecbb62e6b03944def0fc2fe1"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="promo-text">
                                    <h2>Explore open positions in your area</h2>
                                    <a href="../contact/index.php" target="_self" class="common-btn btn_red2 ">Contact
                                        Us</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="widget footer-nav footer-widget-1 widget_nav_menu nav_menu-2">
                                    ...
                                    <div class="menu-footer-column-1-container">
                                        <ul id="menu-footer-column-1" class="menu">
                                            ...
                                            <li id="menu-item-2994" class="menu-item current-menu-item"><a
                                                    href="index.php" aria-current="page">Careers</a></li>
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/careers/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Dec 2024 23:46:48 GMT -->
