...
<html id="sitetop" lang="en-US" class="attop">
    ...
    <body>
        ...
        <section id="page-content-container" class="is-page">
                    ...
                    <div class="row">
                        <div class="block-multicontent__wrapper">
                            ...
                            <div class="block-multicontent__content">
                                ...
                                <p>Whether you choose to apply online or by phone, our friendly loan specialists see
                                    you as much more than your credit score. They’ll get to know you in order to better
                                    understand your needs, clearly explain all of your options, and provide affordable
                                    monthly payments that fit your budget.</p>



                                <p><strong>Here are just some of the ways you can use your
                                        <?php echo $row['name']; ?>:</strong></p>



                                <ul class="wp-block-list has-custom-marker has-disk-custom-marker">
                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Capital Investment
                                                Funds</mark></strong>to
                                        allow individual investors access a diversified portfolio of investments</li>



                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Venture
                                                Capital</mark></strong>supporting startups and early-stage companies
                                        looking to grow rapidly. </li>



                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Startup Loans</mark></strong> to
                                        help you when you need quick cash&nbsp;</li>



                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Debt
                                                Refinance</mark></strong>support small and medium businesses and
                                        entrepreneurs </li>



                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Credit to cover unexpected
                                                expenses</mark></strong>— for whatever life throws your way</li>
                                </ul>
            ...
            <section id="block_daa767158a499273d47d41c82b935943"
                class="block-accordion alignfull block-accordion has-font-color text-default">
                <div class="faq-area">
                    <div class="container">
                        <div class="row text-center">
                            <div class="col-lg-12 mb-5">
                                <div class="area-title">
                                    <h2>Frequently asked questions about personal installment loans</h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="accordion_wrapper">
                                    <div class="accordion" id="accordionExample">
                                        ...
                                        <div class="accordion-item acc0">
                                            <h2 class="accordion-header" id="heading0">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapse0" aria-expanded="false"
                                                    aria-controls="collapseOne">
                                                    What is a personal loan? </button>
                                            </h2>
                                            <div id="collapse0" class="accordion-collapse collapse"
                                                aria-labelledby="heading0" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <p>In the financial industry, ‘personal loan’ refers to money
                                                        borrowed to pay for personal expenses. It is expected to be
                                                        repaid in small portions over time with interest added on.</p>
                                                    <p>Personal loans are often unsecured, meaning borrowers do not risk
                                                        losing their house or car if they can not pay back the loan.</p>
                                                    <p>Repaying personal loans on time helps borrowers establish their
                                                        credit scores. Not paying back a personal loan may have an
                                                        adverse impact on borrowers’ credit scores.</p>
                                                    <p>Unlike car loans, mortgage loans or student loans, which limit
                                                        what a loan can be used for, personal loans allow borrowers to
                                                        use their money however they would like.</p>

                                                </div>
                                            </div>
                                        </div>

                                        <div class="accordion-item acc1">
                                            <h2 class="accordion-header" id="heading1">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapse1" aria-expanded="false"
                                                    aria-controls="collapseOne">
                                                    Are there different types of personal loans? </button>
                                            </h2>
                                            <div id="collapse1" class="accordion-collapse collapse"
                                                aria-labelledby="heading1" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <p>There are two main types of personal loans: secured and
                                                        unsecured.</p>
                                                    <p>With a secured loan, borrowers are asked to provide something of
                                                        value, often the rights to their car or home, to their lender if
                                                        they cannot pay back their loan. With an unsecured loan, lenders
                                                        do not have the right to the borrower&#8217;s personal property,
                                                        even if they default. However, failing to pay back unsecured
                                                        loans will have a negative impact on the borrower’s credit
                                                        history.</p>
                                        ...
                                        <div class="accordion-item acc2">
                                            <h2 class="accordion-header" id="heading2">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapse2" aria-expanded="false"
                                                    aria-controls="collapseOne">
                                                    How does a personal loan work? </button>
                                            </h2>
                                            <div id="collapse2" class="accordion-collapse collapse"
                                                aria-labelledby="heading2" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <p>Personal loans are provided to eligible individuals in the form
                                                        of a check or a bank deposit. They are given in one lump sum and
                                                        then typically repaid by the borrower in smaller installments. A
                                                        fee proportionate to the amount borrowed, called an interest
                                                        rate, is factored into the smaller installment payments. How
                                                        fast a personal loan must be repaid and how much is due every
                                                        month depends on the conditions of the loan and the amount
                                                        borrowed.</p>
                                        ...
                                        <div class="accordion-item acc3">
                                            <h2 class="accordion-header" id="heading3">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapse3" aria-expanded="false"
                                                    aria-controls="collapseOne">
                                                    How do I qualify for a personal loan? </button>
                                            </h2>
                                            <div id="collapse3" class="accordion-collapse collapse"
                                                aria-labelledby="heading3" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <p>Every personal loan company has different criteria for
                                                        qualifying. While some only look at applicants’ credit scores,
                                                        at <?php echo $row['name']; ?> we assess a person’s general
                                                        ability to repay, including factors like source of income, proof
                                                        of residency, ability to incorporate repayments into a monthly
                                                        budget, and repayment history.</p>

                                                </div>
                                            </div>
                                        </div>

                                        <div class="accordion-item acc4">
                                            <h2 class="accordion-header" id="heading4">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapse4" aria-expanded="false"
                                                    aria-controls="collapseOne">
                                                    How quickly can I receive a personal loan? </button>
                                            </h2>
                                            <div id="collapse4" class="accordion-collapse collapse"
                                                aria-labelledby="heading4" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <p>You can receive a personal installment loan from
                                                        <?php echo $row['name']; ?> as soon as the same day you apply!
                                                        Come into a branch to see how much you’re eligible for and
                                                        receive your check after you are approved or apply online and
                                                        have money deposited into your account as early as next day.</p>

                                                </div>
                                            </div>
                                        </div>

                                        <div class="accordion-item acc5">
                                            <h2 class="accordion-header" id="heading5">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapse5" aria-expanded="false"
                                                    aria-controls="collapseOne">
                                                    What credit score is needed for a personal loan? </button>
                                            </h2>
                                            <div id="collapse5" class="accordion-collapse collapse"
                                                aria-labelledby="heading5" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <p>We look at a number of factors in addition to credit history at
                                                        <?php echo $row['name']; ?>. Even individuals with very low
                                                        credit scores may qualify for a loan.</p>

                                                </div>
                                            </div>
                                        </div>

                                        <div class="accordion-item acc6">
                                            <h2 class="accordion-header" id="heading6">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapse6" aria-expanded="false"
                                                    aria-controls="collapseOne">
                                                    Will taking a personal loan affect my credit score? </button>
                                            </h2>
                                            <div id="collapse6" class="accordion-collapse collapse"
                                                aria-labelledby="heading6" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <p><?php echo $row['name']; ?> reports to all three major credit
                                                        bureaus, so taking a
                                                        personal installment loan and repaying it on time gives you a
                                                        chance to positively impact your credit score. Late payments or
                                                        lack of repayment would have a negative impact on credit score.
                                                    </p>
                                        ...
                                        <div class="accordion-item acc7">
                                            <h2 class="accordion-header" id="heading7">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapse7" aria-expanded="false"
                                                    aria-controls="collapseOne">
                                                    Will <?php echo $row['name']; ?> check my credit when I apply for a
                                                    loan? </button>
                                            </h2>
                                            <div id="collapse7" class="accordion-collapse collapse"
                                                aria-labelledby="heading7" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <p>When you apply with <?php echo $row['name']; ?>, there is no
