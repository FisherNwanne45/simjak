...
<html id="sitetop" lang="en-US" class="attop">
    ...
    <body>
        ...
        <section id="page-content-container" class="is-page as-home">
            <div id="heroAreaLoanCheck-block_ef45727e04b416527d192a4fd754723e"
                class="hero-area hero-area-loan-check alignfull new-hero has-note">
                <div class="hero_bg"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-7">
                            <div class="hero-text">
                                <h2>Get the money you need <span class="emphasize">today</span></h2>
                                <div class="herodesc">
                                    <ul>
                                        <li>Personal loans up to $5,000,000<sup>1</sup></li>
                                        <li>Apply with NO impact to your credit score<sup>2</sup></li>
                                        <li>Apply online </li>
                                        <li>Quick funding</li>
                                    </ul>
                                </div>
                                <div class="note-wrapp">
                                    <a class="common-btn btn_red" href="<?php echo $row['apply']; ?>"
                                        target="_blank">Apply Now</a>
                                </div>
                                <div class="copyright_image container d-none d-xl-block">
                                    <p><sup>1</sup>Explore <?php echo $row['name']; ?></p>
                                    <p><sup>2</sup>Being one of the most trusted and respected financial service
                                        providers in <?php echo $row['country']; ?> that cater to over 5 million
                                        customers over the past 30 years, <?php echo $row['name']; ?> very well
                                        understand your financial needs and challenges. That is why we have tailor-made
                                        financial solutions to serve your requirements better.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-5 position-relative sec-col">
                            <img fetchpriority="high" decoding="async" width="2560" height="1575"
                                src="wp-content/uploads/2023/11/girl-2x.png" class="hero_main" alt="girl-2x"
                                srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 650w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 1057w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 325w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 2048w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 1920w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 980w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 1170w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 600w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 975w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 400w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/girl-2x.png 150w"
                            ...
                            <div class="hero_rating">
                                ...
                                <div class="rating-txt">We are Trusted<br>Worldwide</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="legal-under d-xl-none d-block">
                        ...
                        <div class="row align-items-start">
                            <div class="statearea_cs">
                                <div class="state_text">
                                    <p>Check the application status of recent loan amounts requested.</p>
                                </div>
                                <div class="columnSelect">
                                    <a class="common-btn btn_normal" href="<?php echo $row['url']; ?>/track.php"
                                        target="_blank">Track Loan Status</a>
                                </div>
                                <div class="link_apply">
                                    <a class="btn_red3" href="<?php echo $row['apply']; ?>" target="_blank">Apply
                                        now</a>
                                </div>
                            </div>
            ...
            <section id="block_e44b0acb6417a54e7ff1e8550e6a248c"
                class="block-text-icon  alignfull block-text-icon has-font-color text-default">
                <div class="about-area pt-5 mt-lg-5 ">
                    <div class="container-fluid mw-xxl">
                        <div class="row">
                            <div class="area-title text-center">
                                <h2> It’s easy to apply for a <?php echo $row['name']; ?> Loan</h2>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="about-card">
                                    ...
                                    <img width="48" height="65" decoding="async"
                                        src="wp-content/uploads/2023/12/locator.svg" class="" alt="locator" id="4717"
                                        loading="lazy" />
                                    <h4>Check the suitable loan type</h4>
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                                <div class="about-card">
                                    ...
                                    <img width="79" height="55" decoding="async"
                                        src="wp-content/uploads/2023/12/platforms.svg" class="" alt="platforms"
                                        id="4723" loading="lazy" />
                                    <h4>Apply online with NO credit score impact<sup>2</sup></h4>
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                                <div class="about-card">
                                    ...
                                    <img width="77" height="56" decoding="async"
                                        src="wp-content/uploads/2023/12/Fast-Money-Icon.svg" class=""
                                        alt="Fast-Money-Icon" id="4715" loading="lazy" />
                                    <h4>Get your money fast with same-day funding</h4>
                                    <p></p>
                                </div>
                            </div>
                        ...
                        <div class="row text-center mt-3 pb-3 pb-lg-5">
                            <div class="col-lg-12">
                                <div class="more-about">
                                    <div class="button-wrapper">
                                        <a href="<?php echo $row['apply']; ?>/" target="_blank"
                                            class="common-btn btn_red3">Apply Online</a>
                                    </div>

                                    <div class="button-wrapper">
                                        <a href="contact/index.php" target=""
                                            class="common-btn btn_red3-outlined">Contact Us</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row text-center">
                            <div class="col-lg-12 mb-5">
                                <div class="area-title">
                                    <h2>Your loan can go a long way</h2>
                                    <p>Find out if a personal installment loan is right for your needs! Here are just
                                        some of the<br>
                                        ways people like you are using their extra funds to improve the day-to-day</p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="way_wrapper">
                                    ...
                                    <a href="start-up/index.php">
                                        <div class="way_item">
                                            <div class="way_circle">
                                                <img width="62" height="59" decoding="async"
                                                    src="wp-content/uploads/2022/05/SL-personalinstallmentloans-icon-debtconsolidation.svg"
                                                    class="" alt="SL-personalinstallmentloans-icon-debtconsolidation"
                                                    id="1960" loading="lazy" />
                                            </div>
                                            <div class="way_text">
                                                <h4>Startup Loans</h4>
                                                <p>to help you when you need quick cash</p>
                                            </div>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                                <path
                                                    d="M96 480c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L242.8 256L73.38 86.63c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l192 192c12.5 12.5 12.5 32.75 0 45.25l-192 192C112.4 476.9 104.2 480 96 480z" />
            ...
            <section id="block_31d48447c53988c5ccd62d624dff6d7a"
                class="block-multicontent-gutenberg  alignfull block-multicontent-gutenberg block-multicontent__banner--enabled block-multicontent__banner--top has-background-color has-alice-blue-background-color has-font-color text-default">
                <div class="container block-multicontent__container">
                    <div class="row block-multicontent__banner-row">
                        <div class="block-multicontent__banner-wrapper">
                            <div class="block-multicontent__banner bg-yellow">

                                <div class="block-multicontent__stats">
                                    <div class="block-multicontent__stat">
                                        <div class="block-multicontent__stat-value">
                                            75,000+ </div>
                                        <div class="block-multicontent__stat-description">
                                            Happy Customers </div>
                                    </div>
                                    <div class="block-multicontent__stat">
                                        <div class="block-multicontent__stat-value">
            ...
            <section id="block_a8c726545f971bfaad6aea414d4e7f97"
                class="block-testimonial-slider alignfull block-testimonial-slider has-font-color text-default">
                <div class="testimonial-main-area ">
                    <div class="testimonial-area">
                            ...
                            <div class="row">
                                <div class="testimonial-content">
                                    <div class="customer-text">
                                        ...
                                        <p>
                                        <p>We’re committed to providing trustworthy guidance and amazing service. Our
                                            positive reviews show the difference it makes.
                                        </p>
                                        </p>
                        ...
                        <div class="testimonial_slider">
                            <!-- <img width="546" height="626" decoding="async" src="/wp-content/uploads/2022/04/overlay_bg.png" class="overlay_img" alt=""> -->
                            <!--<div class="overlay_testimonial"></div>-->
                            <div class="testimonial_wrapper">

                                <div class="testimonial_item">
                                    <div class="review_card">
                                        <div class="customer_pro">
                                            <div class="r_name">
                                                <h4>Timothy </h4>
                                            </div>
                                            <div class="customer_pic">
                                                <a href="#"><svg width="30" height="26" viewBox="0 0 30 26" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M21.0874 19.4606C21.578 19.079 21.9868 18.6157 22.3139 18.0706C22.641 17.5254 22.9408 16.9531 23.2133 16.3534C23.3223 16.0809 23.4586 15.7266 23.6222 15.2905C23.7312 14.9089 23.7312 14.5273 23.6222 14.1457C23.4586 13.3826 23.077 12.892 22.4774 12.6739C22.3139 12.6194 22.1776 12.5922 22.0686 12.5921C21.9051 12.6467 21.7415 12.6467 21.578 12.5921C20.8693 12.4286 20.297 12.3469 19.8609 12.3469C19.3703 12.3469 18.9887 12.047 18.7161 11.4474C18.5526 11.0658 18.4708 10.6297 18.4708 10.1391C18.4708 9.64853 18.4708 9.15793 18.4708 8.66733L18.4708 3.67953C18.4708 3.13441 18.4708 2.5893 18.4708 2.04419C18.4708 1.55358 18.6071 1.14475 18.8797 0.817679C19.1522 0.436099 19.5611 0.218053 20.1062 0.163541C20.5968 0.109029 21.1419 0.081773 21.7415 0.081773L26.1569 0.0817734C26.593 0.0817735 27.0291 0.0545194 27.4652 9.31515e-06C27.8468 9.3485e-06 28.2011 0.0545195 28.5282 0.163542C29.2914 0.4361 29.7274 0.899446 29.8365 1.55358C29.891 2.26223 29.9182 3.10716 29.9182 4.08837L29.9182 11.6927C29.9182 11.9108 29.9455 12.1288 30 12.3469C30 12.6194 29.9727 12.8647 29.9182 13.0828L29.9182 13.9004C29.8637 14.173 29.8365 14.4455 29.8365 14.7181C29.782 14.9907 29.7274 15.2632 29.6729 15.5358C29.5
19.7059 3.75274 19.3788C4.18883 19.0518 4.57041 18.6429 4.89748 18.1523C5.17004 17.6617 5.4426 17.1166 5.71515 16.517C5.82418 16.2444 5.96046 15.8628 6.12399 15.3722C6.23301 14.8816 6.23301 14.4183 6.12399 13.9822C5.96046 13.2735 5.55162 12.8375 4.89748 12.6739C4.62492 12.5649 4.40688 12.5104 4.24334 12.5104C4.0253 12.5649 3.78 12.5649 3.50744 12.5104C3.12586 12.5104 2.8533 12.4831 2.68977 12.4286C1.8721 12.2651 1.35424 11.829 1.13619 11.1203Z"
                                                            fill="#FAB91B" />
                                                    </svg></a>
                                            </div>
                                        </div>
                                        <div class="rating_icon">
                                            ...
                                            <p>
                                            <p>Returning customer. They always have great and speedy service and
                                                friendly staff ready to assist. Always my go to when we need a little
                                                help especially during these times.</p>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="testimonial_item">
                                    <div class="review_card">
                                        ...
                                        <div class="rating_icon">
                                            ...
                                            <p>
                                            <p>Kenny was very helpful and friendly! He called me by name instead of just
                                                mam. I have never felt more welcome in a place as I was in his office
                                                today! I would recommend them to anyone who needed a little financial
                                                help!! Thanks for a great experience <?php echo $row['name']; ?></p>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="testimonial_item">
                                    <div class="review_card">
                                        ...
                                        <div class="rating_icon">
                                            ...
                                            <p>
                                            <p>In a world where GREAT customer service is hard to find, this company
                                                deserves a tremendous amount of praise and admiration. Thank you for
                                                being awesome and making a stressful situation less tense! You rock!</p>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="testimonial_item">
                                    <div class="review_card">
                                        ...
                                        <div class="rating_icon">
                                            ...
                                            <p>
                                            <p>Amazing customer service. Everything was explained too me and the process
                                                was quick . The application process was very simple . I will be a
                                                customer with <?php echo $row['name']; ?> for a long time</p>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="testimonial_item">
                                    <div class="review_card">
                                        ...
                                        <div class="rating_icon">
                                            ...
                                            <p>
                                            <p>I came in and they helped me with what I needed and got me out the door
                                                quick! Letizia was amazing and very informative. They offer tax
                                                information and it&#8217;s great to know the offers they gave! Online
                                                payment is the best, which they offer!</p>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="testimonial_item">
                                    <div class="review_card">
                                        ...
                                        <div class="rating_icon">
                                            ...
                                            <p>
                                            <p>The staff are very friendly and professional while helping me get the
                                                loan approved and money in my pocket today!</p>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="testimonial_item">
                                    <div class="review_card">
                                        ...
                                        <div class="rating_icon">
                                            ...
                                            <p>
                                            <p>Picked up my loan today very fast process. From the phone process to the
                                                in person service they are very professional and curteous!</p>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="block-multicontent__banner-wrapper">
                            <div class="block-multicontent__banner bg-blue">
                                <div class="block-multicontent__cta-text">
                                    <h2 style="text-align: center;">Apply now with NO credit score impact
                                    </h2>
                                    <p style="text-align: center;">Get same-day approval and fast funding–typically in
                                        less than one hour! </p>
                                </div>
                                <div class="block-multicontent__cta">
                                    <a href="<?php echo $row['apply']; ?>/" class="btn btn-primary" target="_blank">Get
                                        Started</a>
                                </div>
