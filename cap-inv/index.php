                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="page-title white left">
                                    <h1>Capital Investment Funds</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="block-multicontent__wrapper">
                            ...
                            <div class="block-multicontent__content">
                                ...
                                <p>We have tailor-made financial solutions.Capital investment funds allow individual
                                    investors to access a diversified portfolio of investments, reducing the risk
                                    associated with investing in a single company or asset. These funds spread
                                    investments across different sectors, industries, or geographies, which mitigates
                                    potential losses and enhances the likelihood of steady returns.</p>



                                <p><strong>Here are just some benefits with
                                ...
                                <ul class="wp-block-list has-custom-marker has-disk-custom-marker">
                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Liquidity</mark></strong>
                                        through Secondary Markets.</li>



                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Access</mark></strong> to
                                        Professional Management. </li>



                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Potential</mark></strong> for
                                        High Returns.h&nbsp;</li>



                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Ease of
                                                Repayment</mark></strong> at any <?php echo $row['name']; ?> branch.
                                    </li>



                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Exclusive</mark></strong>
