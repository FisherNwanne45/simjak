...
<html id="sitetop" lang="en-US" class="attop">
    ...
    <head>
        ...
        <title>Loan Payment Protection Insurance | <?php echo $row['name']; ?>®</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="page-title white left">
                                    <h1>Loan Payment Protection Insurance</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="achieve-text">
                                    <h2>It’s your money. <sl class="mt-0">Get Protected.</sl>
                                    </h2>
                                    <p>Loan Payment Protection Insurance, offered by Bramer Financial Inc., ensures that
                                        your loan payments are covered in case of unexpected events like job loss,
                                        illness, or disability. This service provides financial stability and peace of
                                        mind, helping you maintain your creditworthiness during challenging times.</p>
