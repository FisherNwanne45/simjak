...
<html id="sitetop" lang="en-US" class="attop">
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/auto-club/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Dec 2024 23:45:35 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <link rel="alternate" hreflang="es" href="../es/servicios-de-emergencia-en-carretera/index.php" />
        ...
        <title>Roadside Emergency Service &amp; More - Auto Club | <?php echo $row['name']; ?>®</title>
        ...
        <meta name="description"
            content="<?php echo $row['name']; ?> has partnered with PTS Auto Club to provide additional roadside services that go beyond your regular car insurance. Learn more here!" />
        <link rel="canonical" href="index.php" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="article" />
        <meta property="og:title"
            content="Roadside Emergency Service &amp; More - Auto Club | <?php echo $row['name']; ?>®" />
        <meta property="og:description"
            content="<?php echo $row['name']; ?> has partnered with PTS Auto Club to provide additional roadside services that go beyond your regular car insurance. Learn more here!" />
        <meta property="og:url" content="index.php" />
        <meta property="og:site_name" content="<?php echo $row['name']; ?>" />
        <meta property="article:modified_time" content="2024-05-23T15:00:14+00:00" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "<?php echo $row['url']; ?>auto-club/",
                "url": "<?php echo $row['url']; ?>auto-club/",
                "name": "Roadside Emergency Service & More - Auto Club | <?php echo $row['name']; ?>®",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>#website"
                },
                "datePublished": "2022-05-06T00:55:41+00:00",
                "dateModified": "2024-05-23T15:00:14+00:00",
                "description": "<?php echo $row['name']; ?> has partnered with PTS Auto Club to provide additional roadside services that go beyond your regular car insurance. Learn more here!",
                "breadcrumb": {
                    "@id": "<?php echo $row['url']; ?>auto-club/#breadcrumb"
                },
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["<?php echo $row['url']; ?>auto-club/"]
                }]
            }, {
                "@type": "BreadcrumbList",
                "@id": "<?php echo $row['url']; ?>auto-club/#breadcrumb",
        ...
        <link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/1825.json" />
        <link rel='shortlink' href='../index1b9e.php?p=1825' />
        <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed"
            href="../wp-json/oembed/1.0/embed2208.json?url=<?php echo $row['url']; ?>auto-club%2F" />
        <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed"
            href="../wp-json/oembed/1.0/embedf162?url=<?php echo $row['url']; ?>auto-club%2F&amp;format=xml" />
    ...
    <body>
                                            ...
                                            <li itemscope="itemscope"
                                                ...
                                                <ul class="wpml-ls-sub-menu dropdown-menu">
                                                    ...
                                                    <li itemscope="itemscope"
                                                        ...
                                                        <a href="../es/servicios-de-emergencia-en-carretera/index.php"
                                                            class="wpml-ls-link">
                                        ...
                                        <li itemscope="itemscope"
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li class="menu-item nav-item lang-item"><a
                                                        href="../es/servicios-de-emergencia-en-carretera/index.php"
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="menu-item-dropdown-2635"
                                                ...
                                                <li itemscope="itemscope"
                                                    ...
                                                    class="menu-item current-menu-item active nav-item"><a
                                                        title="Auto Club" href="index.php" class="dropdown-item">Auto
                                                        Club</a></li>
                                            </ul>
                                        </li>
                                        <li itemscope="itemscope"
        ...
        <section id="page-content-container" class="is-page">
            ...
            <section id="block_57d026c28fb7af178b23ac4f196a376c"
            ...
            <div class="wp-block-group is-layout-constrained wp-block-group-is-layout-constrained">
                <p class="has-text-align-center"
                    style="margin-top:var(--wp--preset--spacing--80);margin-right:var(--wp--preset--spacing--60);margin-bottom:var(--wp--preset--spacing--60);margin-left:var(--wp--preset--spacing--60);padding-top:0;padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--40);font-size:21px">
                    We partner with PTS Auto Club to provide additional roadside services that go beyond your regular
                    car insurance to keep you on the road with confidence.</p>



                <p class="has-text-align-center" style="font-size:21px">Plans are $8 a month for individuals and $10 a
                    month for families. <br>Our plans are flexible, with 3, 6, 9 and 12 month terms
                    available!<sup>1</sup></p>
            </div>



            <div class="wp-block-group is-layout-constrained wp-block-group-is-layout-constrained"
                style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--30)">
                <div
                    ...
                    <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow" style="flex-basis:70%">
                        <p class="has-text-align-center text-center text-md-start" style="font-size:18px;line-height:1">
                            <strong>Benefits Include:</strong></p>



                        <ul class="has-custom-marker has-checkmark-custom-marker wp-block-list">
                            <li>Towing Reimbursement ($85)<sup>2</sup></li>



                            <li>Lockout Reimbursement ($85)<sup>2</sup></li>



                            <li>Flat Tire Repair ($15)<sup>2</sup></li>



                            <li>Battery Charge ($15)<sup>2</sup></li>



                            <li>Traffic Court Defense Fee Reimbursement ($175)<sup>2</sup></li>



                            <li>Stolen Automobile Reward ($2,500)</li>
            ...
            <section id="block_dab5509349def98821df9e0cf1e447e0"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="promo-text">
                                    <h2>Ready to join <?php echo $row['name']; ?> Auto Club?</h2>
                                    <a href="../contact/index.php" target="_self"
                                        class="common-btn btn_red2 ">Contact Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <p class="has-text-align-center"
                ...
                <sup>1</sup> Auto club available in Nevada and Missouri. Services and products are subject to change at
                any time for any reason.<br><sup>2</sup> Reimbursement amount per occurrence. Other exclusions may
                apply.</p>
        ...
        <div class="wpml-ls-statics-footer wpml-ls wpml-ls-legacy-list-horizontal">
            <ul>
                ...
                <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"
                    ...
                    <a href="../es/servicios-de-emergencia-en-carretera/index.php" class="wpml-ls-link">
                        <img width="18" height="12" class="wpml-ls-flag"
...
<?php echo $row['tawk']; ?>
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/auto-club/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Dec 2024 23:45:39 GMT -->
