                    ...
                    <div class="row">
                        <div class="block-multicontent__wrapper">
                            ...
                            <div class="block-multicontent__content">
                                ...
                                <p>Are you a small business owner looking to expand your business?, or are you an
                                    entrepreneur looking to start your own business and need financial
                                    assistance?<br><br>

                                    The microfinance loan product of <?php echo $row['name']; ?> designed to support
                                    small and medium entrepreneurs provides tailor-made loan products after evaluating
                                    your business. You do not have to let go of your business idea or delay the
                                    expansion plans because you are short of funds.
                                    <br><br>
                                    We will further provide you with entrepreneurship training and support to develop
                                    your businesses as we strongly believe in your success.



                                <p><strong>Here are just some of the ways you can benefit:</strong></p>



                                <ul class="wp-block-list has-custom-marker has-disk-custom-marker">
                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Offering </mark></strong>
                                        attractive interest rate</li>



                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Fast</mark></strong> and
                                        efficient service.</li>



                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Flexible</mark></strong>
                                        repayment terms.&nbsp;</li>
