                    ...
                    <div class="row">
                        <div class="block-multicontent__wrapper">
                            ...
                            <div class="block-multicontent__content">
                                ...
                                <p>Venture Capital is a special loan scheme offered by <?php echo $row['name']; ?> to
                                    its customers for the purpose of supporting startups and early-stage companies
                                    looking to grow rapidly. <?php echo $row['name']; ?> brings extensive experience,
                                    industry knowledge, and expertise to the table. We offer mentorship, guidance in
                                    strategic decisions, and advice on product development, go-to-market strategies, and
                                ...
                                <ul class="wp-block-list has-custom-marker has-disk-custom-marker">
                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Reasonable tariffs
                                            </mark></strong> and charges in the market.</li>



                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Offer draft
                                                facilities</mark></strong> against debts.</li>



                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Ability to go
                                                for</mark></strong> flexible tenors.h&nbsp;</li>



                                    <li><strong><mark style="background-color:rgba(0, 0, 0, 0)"
                                                class="has-inline-color has-blue-color">Fast approval </mark></strong>
                                        and efficient service. </li>
