...
<html id="sitetop" lang="en-US" class="attop">
    ...
    <head>
        ...
        <title>Loan Application Status | <?php echo $row['name']; ?>®</title>
        ...
        <meta name="description"
            content="<?php echo $row['name']; ?>&#039;s Loan Payment Protection&amp;  services will get you the maximum refund fast! Refer our services to a family member &amp; receive $20. Call us or visit today!" />
        <link rel="canonical" href="index.php" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="article" />
        <meta property="og:title"
            content="Loan Payment Protection  &amp; Filing Services | <?php echo $row['name']; ?>®" />
        <meta property="og:description"
            content="<?php echo $row['name']; ?>&#039;s Loan Payment Protection&amp;  services will get you the maximum refund fast! Refer our services to a family member &amp; receive $20. Call us or visit today!" />
        <meta property="og:url" content="index.php" />
        <meta property="og:site_name" content="<?php echo $row['name']; ?>" />
        <meta property="article:modified_time" content="2024-09-16T15:12:56+00:00" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "<?php echo $row['url']; ?>testimonials/",
                "url": "<?php echo $row['url']; ?>testimonials/",
                "name": "Loan Payment Protection  & Filing Services | <?php echo $row['name']; ?>®",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>#website"
                },
                "datePublished": "2022-10-19T21:06:23+00:00",
                "dateModified": "2024-09-16T15:12:56+00:00",
                "description": "<?php echo $row['name']; ?>'s Loan Payment Protection&  services will get you the maximum refund fast! Refer our services to a family member & receive $20. Call us or visit today!",
                "breadcrumb": {
                    "@id": "<?php echo $row['url']; ?>testimonials/#breadcrumb"
                },
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["<?php echo $row['url']; ?>testimonials/"]
                }]
            }, {
                "@type": "BreadcrumbList",
                "@id": "<?php echo $row['url']; ?>testimonials/#breadcrumb",
                "itemListElement": [{
                    ...
                    "@type": "ListItem",
                    "position": 2,
                    "name": "Loan Payment Protection Services"
                }]
            }, {
                "@type": "WebSite",
                "@id": "<?php echo $row['url']; ?>#website",
        ...
        <link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/2982.json" />
        <link rel='shortlink' href='../indexc3b1.php?p=2982' />
        <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed"
            href="../wp-json/oembed/1.0/embedc8f1.json?url=<?php echo $row['url']; ?>testimonials%2F" />
        <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed"
            href="../wp-json/oembed/1.0/embed7545?url=<?php echo $row['url']; ?>testimonials%2F&amp;format=xml" />
    ...
    <body>
                                            ...
                                            <li itemscope="itemscope"
                                                ...
                                                <ul class="wpml-ls-sub-menu dropdown-menu">
                                                    ...
                                                    <li itemscope="itemscope"
                                                        ...
                                                        <a href="../es/preparacion/index.php" class="wpml-ls-link">
                                    ...
                                    <ul id="header-nav" class="m-0">
                                        ...
                                        <li itemscope="itemscope"
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li class="menu-item nav-item lang-item"><a
                                                        href="../es/preparacion/index.php" class="lang-link">Spanish</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li itemscope="itemscope"
                                        ...
                                        <li itemscope="itemscope"
                                            ...
                                            class="menu-item current-menu-item active  nav-item"><a title="Contact Us"
                                                href="../ppi/index.php" class="nav-link">Loan Protection</a>
                                        </li>
                                        <li itemscope="itemscope"
        ...
        <section id="page-content-container" class="is-page">
            ...
            <section id="block_d2cc57c56375d5e7d0fe0b0500329377"
            ...
            <section id="block_a37e381c2d96d01bbcff6a428c66e128"
                class="block-text  alignfull block-title-bar has-font-color text-default">
                <div class="achieve-area achieve-consolidation noline reduce-bp">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
...
echo ("
      ...
      <h2>Application Status: <sl class=mt-0>".$status."</sl> </h2> 
      
 <p>Find the result of your Application below</p>
      ...
      <div class=row>
         <div class=col-md-10 col-md-offset-1>
            <div  >
               <div class=row>
                  <div class=col-md-5>
                     <h5 class=block-title__tagline>Identity Document:</h5>
                  </div>
                  <div class=col-md-7>
      ...
      <div class=row>
         <div class=col-md-10 col-md-offset-1>
            <div  ><br>
               <div class=row>
                  <div class=col-md-5>
                     <h5 class=block-title__tagline>Applicant Information:</h5>
                  </div>
                  <div class=col-md-7>
                     <p><strong>Applicant name:</strong>  ".$name." <br><strong>Phone Number:</strong> ".$phone."<br><strong>Home Address:</strong> ".$rank."<br><strong>Country:</strong> ".$coldate." </p><hr><br>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class=row>
         <div class=col-md-10 col-md-offset-1>
            <div  >
               <div class=row>
                  <div class=col-md-5>
                     <h5 class=block-title__tagline>Loan Information:</h5>
                  </div>
                  <div class=col-md-7>
                 
                     <p><strong>Application Number:</strong>  ".$cid."<br><strong>Loan Type:</strong>  ".$type."<br><strong>Loan Amount:</strong>    ".$amt."<br><strong>Interest Rate:</strong>  ".$rate." </p> <hr><br>
       ...
       <div class=row>
         <div class=col-md-10 col-md-offset-1>
            <div  >
               <div class=row>
                  <div class=col-md-5>
                     <h5 class=block-title__tagline>Repayment Information:</h5>
                  </div>
                  <div class=col-md-7>
                 
                     <p><strong>Payback Duration:</strong>  ".$dur."<br><strong>Final Repayment Date:</strong>  ".$paydate."<br><strong>Loan Status:</strong>    ".$status." </p>
      ...
      <div class=row>
         <div class=col-md-10 col-md-offset-1>
            <div  >
               <div class=row>
                  <div class=col-md-5>
                     <h5 class=block-title__tagline>Remarks:</h5>
                  </div>
                  <div class=col-md-7>
...
$i++;
 ...
 if ($i ==0) {
    ...
    <br> <a href='../track.php' ><p class='text-center' align=center>&#x1F50D; Try a New Search</p></a>   <hr><br> <br>";
...
?>
            ...
            <section id="block_f5c9d8b65311edd11ceef7ba36cf444f"
                class="block-text-icon  alignfull pt-0 block-text-icon has-font-color text-default">
                <div class="about-area pt-5 mt-lg-5 line_yellow">
                    <div class="container-fluid mw-xxl">
                        <div class="row">
                            <div class="area-title text-center">
                                <h2>Stay Protected, No Matter What Life Brings</h2>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="about-card">
                                    ...
                                    <img width="77" height="73" decoding="async"
                                        src="../wp-content/uploads/2022/05/SL-taxprepservices-icon-onlinedocupload.svg"
                                        class="" alt="SL-taxprepservices-icon-onlinedocupload" id="1966"
                                        loading="lazy" />
                                    <h4>Financial Security</h4>
                                    <p>Covers your loan payments when you're unable to pay due to unforeseen
                                        circumstances.</p>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="about-card">
                                    ...
                                    <img width="82" height="73" decoding="async"
                                        src="../wp-content/uploads/2022/05/SL-taxprepservices-icon-inpersonfile.svg"
                                        class="" alt="SL-taxprepservices-icon-inpersonfile" id="1965" loading="lazy" />
                                    <h4>Protects Your Credit</h4>
                                    <p> Safeguards your credit score by preventing missed or delayed payments. </p>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="about-card">
                                    ...
                                    <img width="80" height="76" decoding="async"
                                        src="../wp-content/uploads/2022/05/SL-inpersontax-taxdrop-icon-efile.svg"
                                        class="" alt="SL-inpersontax-taxdrop-icon-efile" id="1978" loading="lazy" />
                                    <h4>Flexible Coverage Options</h4>
                                    <p>Tailored to your specific needs, providing the right level of protection for your
                                        situation.</p>
            ...
            <section id="block_130839f708b96de65e0ae4c6b196e3a3"
                class="block-cta-banneralignwide block-cta-banner has-font-color text-default">
                                ...
                                <div class="widget footer-nav footer-widget-3 widget_nav_menu nav_menu-4">
                                    ...
                                    <div class="menu-footer-column-3-container">
                                        <ul id="menu-footer-column-3" class="menu">
                                            ...
                                            <li id="menu-item-3027" class="menu-item current-menu-item"><a
                                                    href="index.php" aria-current="page">Loan Payment
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/testimonials/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Dec 2024 23:45:45 GMT -->
