...
<html id="sitetop" lang="en-US" class="attop">
    ...
    <head>
        ...
        <title>Client Area | <?php echo $row['name']; ?>®</title>
                            ...
                            <div class="col-lg-12">
                                <div class="promo-text">
                                    ...
                                    .centralize {
                                        ...
                                        /* Optional: Ensures the parent container has height for vertical centering */
                                    }
                                    </style>
                                    ...
                                    <div class="row ">
                                            ...
                                            <form action=" " method="POST">
                                                ...
                                                <div class=" align-items-center">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Email / User ID" name="username" required><br>

                                                    <input type="text" class="form-control" placeholder="Enter Password"
                                                        name="password" required>
                                                    <br>
                                                    <button type="submit" value="Submit" name="submit"
                                                        class="common-btn btn_red2 ">Login</button><!-- /.thm-btn -->
                                        ...
                                        <div class="row col-lg-3"><img fetchpriority="high" decoding="async" width="820"
                                                height="884" src="../wp-content/uploads/2023/12/Masked-Image-1-1.png"
                                                ...
                                                sizes="(max-width: 820px) 100vw, 820px" /></div>
