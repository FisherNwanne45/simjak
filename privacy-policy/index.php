...
<html id="sitetop" lang="en-US" class="attop">
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/privacy-policy/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Dec 2024 23:47:00 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <link rel="alternate" hreflang="es" href="../es/politica-de-privacidad/index.php" />
        ...
        <meta property="og:title" content="Privacy Policy | <?php echo $row['name']; ?>" />
        <meta property="og:description"
            content="Last modified: July 7, 2022 Introduction <?php echo $row['name']; ?> (“Company”&nbsp;or&nbsp;“We”) respect your privacy and are committed to protecting it through our compliance with this policy. This policy describes the types of information we may collect from you or that you may provide when you visit the website&nbsp;<?php echo $row['url']; ?>,&nbsp;<?php echo $row['url']; ?>, and any related websites on which this Privacy..." />
        <meta property="og:url" content="index.php" />
        <meta property="og:site_name" content="<?php echo $row['name']; ?>" />
        <meta property="article:modified_time" content="2023-12-06T18:02:55+00:00" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "<?php echo $row['url']; ?>privacy-policy/",
                "url": "<?php echo $row['url']; ?>privacy-policy/",
                "name": "Privacy Policy | <?php echo $row['name']; ?>",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>#website"
                },
                "datePublished": "2022-04-26T09:51:09+00:00",
                "dateModified": "2023-12-06T18:02:55+00:00",
                "breadcrumb": {
                    "@id": "<?php echo $row['url']; ?>privacy-policy/#breadcrumb"
                },
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["<?php echo $row['url']; ?>privacy-policy/"]
                }]
            }, {
                "@type": "BreadcrumbList",
                "@id": "<?php echo $row['url']; ?>privacy-policy/#breadcrumb",
        ...
        <link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/1252.json" />
        <link rel='shortlink' href='../indexb09c.php?p=1252' />
        <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed"
            href="../wp-json/oembed/1.0/embedd60e.json?url=<?php echo $row['url']; ?>privacy-policy%2F" />
        <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed"
            href="../wp-json/oembed/1.0/embed042f?url=<?php echo $row['url']; ?>privacy-policy%2F&amp;format=xml" />
        ...
        <meta name="generator" content="WP Rocket 3.17.3.1"
            data-wpr-features="wpr_delay_js wpr_defer_js wpr_minify_js wpr_lazyload_iframes wpr_image_dimensions wpr_minify_css wpr_desktop" />
    </head>
    ...
    <body>
                                            ...
                                            <li itemscope="itemscope"
                                                ...
                                                <ul class="wpml-ls-sub-menu dropdown-menu">
                                                    ...
                                                    <li itemscope="itemscope"
                                                        ...
                                                        <a href="../es/politica-de-privacidad/index.php"
                                                            class="wpml-ls-link">
                                        ...
                                        <li itemscope="itemscope"
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li class="menu-item nav-item lang-item"><a
                                                        href="../es/politica-de-privacidad/index.php"
        ...
        <section id="page-content-container" class="is-page">
            ...
            <section id="block_93e3314125db57ee485a39fda2be3d09"
                class="block-hero-bar alignfull block-hero-bar has-font-color text-default">
                <div class="page-title-area black">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                    ...
                    <img width="1337" height="167" decoding="async"
            ...
            <section id="contact-content"
                ...
                <div
                    ...
                    <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow" style="flex-basis:100%">
                        ...
                        <p><?php echo $row['name']; ?> (<strong>“Company”</strong>&nbsp;or&nbsp;<strong>“We”</strong>)
                            respect your
                        ...
                        <p>This Privacy Policy supplements our Privacy Notice.&nbsp; Please also review the Terms
                            of&nbsp;Use.&nbsp; The&nbsp;Terms of Use&nbsp;govern Your use of the Site.&nbsp; By using
                            the Site, You agree to this Privacy Policy and the&nbsp;Terms of Use.&nbsp; You also agree
                            to our collection, use, disclosure, and storage of Your Personal Information (defined below)
                            as described in this Privacy Policy.&nbsp; If You do not agree to the terms of this Privacy
                            Policy, please do not provide us with any Personal Information and do not use this Site.</p>
                        ...
                        <ul class="wp-block-list">
                            <li>Us offline or through any other means, including on any other website operated by
                                Company or any third party (including our affiliates and subsidiaries);</li>



                            <li>Data we get from third parties, unless we combine such data with Personal Information
                                (defined below) that we have collected under this Privacy Policy; or</li>
                        ...
                        <h2 class="wp-block-heading">Children Under the Age of 18</h2>
                        ...
                        <p>Our Website is not intended for children under 18 years of age. No one under age 18 may
                            ...
                            information on this Website or on or through any of its features. If we learn we have
                            collected or received personal information from a child under 18, we will delete
                            that&nbsp;information. If You believe we might have any information from or about a child
                            under 18, please contact us at:</p>



                        <p><?php echo $row['name']; ?><br><?php echo $row['addr']; ?><br><br><a
                                href="../cdn-cgi/l/email-protection.php#aecdc1c0dacfcddaeeccdcdbc0cacfc9cbc3c9da80cdc1c3"><span
                                    class="__cf_email__"
                                    data-cfemail="583b37362c393b2c183a2a2d363c393f3d353f2c763b3735">
                                    <?php echo $row['email']; ?></span></a>
                        </p>



                        <h2 class="wp-block-heading">Information We Collect About You and How We Collect It</h2>
                        ...
                        <ul class="wp-block-list">
                            <li>By which You may be personally identified, such as full name, date of birth,
                                relationship status, postal address, e-mail address, telephone number, social security
                                number, driver’s license number, employment information, information about Your debts,
                                assets, and income, bank account and/or payment card information, username or any other
                                identifier by which You may be contacted online or offline (“<strong>Personal
                                    Information</strong>“);</li>



                            <li>That is about You but individually does not identify You, such as the type&nbsp;of Your
                                device; about Your internet connection, the equipment You use to access our Website, and
                                usage details.</li>
                        </ul>
                        ...
                        <ul class="wp-block-list">
                            <li>Directly from You when You provide it to us including if You create an online account
                                with us so that You can view information such as: Your last payment date and amount,
                                loan balance and upcoming payment amount and date.&nbsp;&nbsp; We will not sell, share,
                                or otherwise distribute Your Personal Information to third parties, unless clearly
                                disclosed within this Privacy Policy or our Privacy Notice.&nbsp; &nbsp;&nbsp;</li>
                            ...
                            <li>Automatically as You navigate through the site. Information collected automatically may
                                ...
                                beacons, java script, and other tracking technologies.</li>
                        ...
                        <h2 class="wp-block-heading">Information You Provide to Us</h2>
                        ...
                        <ul class="wp-block-list">
                            <li>Information that You provide by filling in forms on our Website. This includes
                                information provided at the time of registering to use our Website, loan application
                                documents, documents uploaded by You in support of Your loan application, documents
                                uploaded by You in support of or for servicing Your account, for example, refinancing
                                and other similar account servicing tasks,&nbsp;or You requesting further services. We
                                may also ask You for information when You enter a contest or promotion sponsored by us,
                                and when You report a problem with our Website.</li>
                        ...
                        <h2 class="wp-block-heading">Information We Collect Through Automatic Data Collection
                            Technologies</h2>
                        ...
                        <ul class="wp-block-list">
                            <li>Details of Your visits to our Website, including traffic data, location data, logs, and
                                other communication data and the resources that You access and use on the Website.</li>



                            <li>Information about Your computer and internet connection, including Your IP address,
                                operating system, and browser type.</li>
                        </ul>



                        <p>The information we collect automatically does include personal information, or we may
                        ...
                        <ul class="wp-block-list">
                            <li><strong>Cookies (or Browser Cookies).</strong>&nbsp;A cookie is a small file placed on
                                the hard drive of Your computer. You may refuse to accept browser cookies by activating
                                the appropriate setting on Your browser. However, if You select this setting You may be
                                ...
                                Your browser to our Website.</li>



                            <li><strong>Web Beacons.</strong>&nbsp;Pages of our Website and our emails may contain small
                            ...
                            <li><strong>JavaScript.&nbsp;&nbsp;</strong>JavaScript is a text-based programming language
                                that allows web pages to be interactive.&nbsp; JavaScript gives web pages interactive
                                elements. Common examples of JavaScript that You might encounter include a search box,
                                the branch locator, the ability to make an online payment or the ability to upload
                                documents.&nbsp; Using JavaScript we capture Your device type and Your IP address which
                                permit the Company, for example, to count users who have visited those pages for other
                                related website statistics (for example, recording the popularity of certain website
                                content and verifying system and server integrity) and to optimize user experience.</li>
                        </ul>
                        ...
                        <ul class="wp-block-list">
                            <li>Some content or applications on the Website are served by third-parties, content
                                ...
                                services. &nbsp;We do not control these third parties’ tracking technologies or how they
                                may be used.</li>
                        </ul>
                        ...
                        <ul class="wp-block-list">
                            ...
                            <li>To provide You with information, products, or services that You request from us. For
                                example, to process Your loan inquiry, in the loan application process, to underwrite
                                Your loan, to process and fund Your loan, to service Your loan, to request or receive
                                payments, information such as account notices, verify Your identity, prevent fraud,
                                create and provide access to Your account, communicate with You about Your transactions,
                                provide customer support, offer other products and services, send receipts or
                                statements, and for other internal business purposes.</li>
                            ...
                            <li>To carry out our obligations and enforce our rights arising from any loan contracts
                                entered into between You and us, including for billing and collection.</li>
                        ...
                        <p>We may also use Your information to contact You about goods and services that may be of
                            interest to You if You opt-in to those services.</p>
                        ...
                        <ul class="wp-block-list">
                            ...
                            <li>To a buyer or other successor in the event of a merger, divestiture, restructuring,
                                ...
                                <?php echo $row['name']; ?>’s assets, whether as a going concern or as part of
                                bankruptcy, liquidation, or similar proceeding, in which personal information held by
                                <?php echo $row['name']; ?> about our Website users is among the assets transferred.
                            </li>



                            <li>To fulfill the purpose for which You provide it. For example, if You give us an email
                                address or contact information to use the “refer a friend” feature of our Website, we
                                will transmit the contents of that referral and Your name and email address&nbsp;to our
                                branches and call center.</li>
                        ...
                        <ul class="wp-block-list">
                            ...
                            <li>To enforce our agreements, including for collection purposes.</li>
                        </ul>



                        <p>Please see our Privacy Notice for more information on how Personal Information may be shared
                            and how You may be able to limit certain types of sharing.</p>



                        <h2 class="wp-block-heading">Choices about How We Use and Disclose Your Information</h2>
                        ...
                        <ul class="wp-block-list">
                            <li><strong>Tracking Technologies.</strong>&nbsp;You can set Your browser to refuse all or
                            ...
                            <li><strong>Disclosure of Your Information for Third-Party Advertising.</strong>&nbsp;Sun
                                Loan does not share or sell Your information with third-parties.&nbsp; See
                                <?php echo $row['name']; ?>’s Privacy Notice for more information.&nbsp;</li>
                        </ul>



                        <h2 class="wp-block-heading">Accessing and Correcting Your Information</h2>



                        <p>It is very important that Your personal information is accurate and up to date.&nbsp; You can
                            review and change Your personal information by logging into the Website and visiting Your
                            account profile page.</p>



                        <h2 class="wp-block-heading">Location of Website</h2>



                        <p>The website is operated in the <?php echo $row['country']; ?>.&nbsp; The website is meant
                            only for users
                            located in the <?php echo $row['country']; ?>.&nbsp;</p>
                        ...
                        <p>We reserve the right to change or modify this Privacy Policy at our sole discretion at any
                            time.&nbsp; If we make material changes to how we treat our users’ personal information, we
                            will update You through a notice on the Website home page. The date the privacy policy was
                            last revised is identified at the top of the page. You are responsible periodically visiting
                            our Website and this privacy policy to check for any changes.&nbsp; Your continued use of
                            any of the site following the posting of changes to our Privacy Policy means You accept
                            those changes.&nbsp;</p>
                                ...
                                <div class="widget footer-nav footer-widget-2 widget_nav_menu nav_menu-3">
                                    ...
                                    <div class="menu-footer-column-2-container">
                                        <ul id="menu-footer-column-2" class="menu">
                                            ...
                                            <li id="menu-item-2997" class="menu-item current-menu-item"><a
                                                    href="index.php" aria-current="page">Privacy Policy</a></li>
                                            <li id="menu-item-2996" class="menu-item"><a href="../ #"> </a>
                                            </li>
                                            <li id="menu-item-3550" class="menu-item"><a href="../ #"> </a></li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="menu-footer-column-3-container">
                                        <ul id="menu-footer-column-3" class="menu">
                                            ...
                                            <li id="menu-item-3027" class="menu-item"><a
                                                    href="../testimonials/index.php">Loan Payment Protection
                                                    Services</a></li>
        ...
        <div class="wpml-ls-statics-footer wpml-ls wpml-ls-legacy-list-horizontal">
            <ul>
                ...
                <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"
                    ...
                    <a href="../es/politica-de-privacidad/index.php" class="wpml-ls-link">
                        <img width="18" height="12" class="wpml-ls-flag"
        ...
        var rocket_beacon_data = {
            "ajax_url": "<?php echo $row['url']; ?>/wp-admin\/admin-ajax.php",
            "nonce": "24cf84dc19",
            "url": "<?php echo $row['url']; ?>/privacy-policy",
            "is_mobile": false,
        ...
        <script data-name="wpr-wpr-beacon" src='../wp-content/plugins/wp-rocket/assets/js/wpr-beacon.min.js' async>
        </script>
        <script>
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/privacy-policy/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Dec 2024 23:47:04 GMT -->
