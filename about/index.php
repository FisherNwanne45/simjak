...
<html id="sitetop" lang="en-US" class="attop">
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/about/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Dec 2024 23:45:22 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <link rel="alternate" hreflang="es" href="../es/acerca/index.php" />
        ...
        <title>About Us | <?php echo $row['name']; ?>®</title>
        ...
        <meta name="description"
            content="<?php echo $row['name']; ?> provides personal installment loans in more than 250 locations in the US. We have over 30 years experience - learn more about our company today!" />
        <link rel="canonical" href="index.php" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="About Us | <?php echo $row['name']; ?>®" />
        <meta property="og:description"
            content="<?php echo $row['name']; ?> provides personal installment loans in more than 250 locations in the US. We have over 30 years experience - learn more about our company today!" />
        <meta property="og:url" content="index.php" />
        <meta property="og:site_name" content="<?php echo $row['name']; ?>" />
        <meta property="article:modified_time" content="2024-07-16T15:38:42+00:00" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "<?php echo $row['url']; ?>about/",
                "url": "<?php echo $row['url']; ?>about/",
                "name": "About Us | <?php echo $row['name']; ?>®",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>#website"
                },
                "datePublished": "2022-07-27T17:23:38+00:00",
                "dateModified": "2024-07-16T15:38:42+00:00",
                "description": "<?php echo $row['name']; ?> provides personal installment loans in more than 250 locations in the US. We have over 30 years experience - learn more about our company today!",
                "breadcrumb": {
                    "@id": "<?php echo $row['url']; ?>about/#breadcrumb"
                },
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["<?php echo $row['url']; ?>about/"]
                }]
            }, {
                "@type": "BreadcrumbList",
                "@id": "<?php echo $row['url']; ?>about/#breadcrumb",
        ...
        <link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/1207.json" />
        <link rel='shortlink' href='../indexa60b.php?p=1207' />
        <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed"
            href="../wp-json/oembed/1.0/embed073f.json?url=<?php echo $row['url']; ?>about%2F" />
        <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed"
            href="../wp-json/oembed/1.0/embeda234?url=<?php echo $row['url']; ?>about%2F&amp;format=xml" />
    ...
    <body>
                                            ...
                                            <li itemscope="itemscope"
                                                ...
                                                <ul class="wpml-ls-sub-menu dropdown-menu">
                                                    ...
                                                    <li itemscope="itemscope"
                                                        ...
                                                        <a href="../es/acerca/index.php" class="wpml-ls-link">
                                        ...
                                        <li itemscope="itemscope"
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li class="menu-item nav-item lang-item"><a
                                                        href="../es/acerca/index.php" class="lang-link">Spanish</a></li>
                                            </ul>
                                        </li>
                                        <li itemscope="itemscope"
                                            itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-1579"
                                            class="menu-item current-menu-item active nav-item"><a title="About Us"
                                                href="index.php" class="nav-link">About Us</a></li>
                                        <li itemscope="itemscope"
        ...
        <section id="page-content-container" class="is-page">
            ...
            <section id="block_c2bd94032bab0c6cb8a15687fb5d9c9b"
            ...
            <section id="block_897f3f212484dc1b6a8e9cf811a86438"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="achieve-text">
                                    <h2>
                                        <sl class="keep-arc">Helping you</sl> achieve financial peace of mind
                                    </h2>
                                    <p><strong>Throughout our history, we’ve been helping people with personal
                                            installment loans.</strong></p>
                                    <p>Our friendly and professional loan specialists work with each customer to ensure
                                        an affordable payment plan that fits their needs.</p>
            ...
            <section id="block_9eca27a128e5d475b98009bc892fa22a"
                class="block-2col-text alignfull block-2col-text has-font-color text-default">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="informative-text">
                                    ...
                                    <div class="info-item">
                                        <div class="info_left">
                                            <h3>Helpful &#038; informative</h3>
                                        </div>
                                        <div class="info_right">
                                            <h4>We’ll help you understand your options</h4>
                                            <p>Our team is trained to assist you with financial decisions by providing a
                                                monthly budgeting overview and helping you understand your repayment
                                                plans.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="info-item">
                                        ...
                                        <div class="info_right">
                                            <h4>We provide opportunities to protect your loans</h4>
                                            <p><?php echo $row['name']; ?> ensures that your loan payments are covered
                                                in case of unexpected events like job loss, illness, or disability.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info_right">
                                            <h4>We take the personal loan business personally</h4>
                                            <p>Whether you opt for online, phone, or in-branch assistance, we’ll go out
                                                of our way to ensure we provide clear information, and loan terms that
                                                fit your needs.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="all-about">
                                    <h2>It’s all about you. <img width="128" height="25" decoding="async"
                                            src="../wp-content/uploads/2022/04/shp-4.svg" alt=""></h2>
                                </div>
                            </div>
            ...
            <section id="block_e1fb81b11ffe8ccf779a6ec0159d587f"
                class="block-timeline alignfull block-timeline has-font-color text-default">
                <div class="timeline-area">
                    <div class="container">
                            ...
                            <div class="col-lg-12">
                                <div class="timeline_wrapper">
                                    <div class="timeline_top">
                                        ...
                                        <div class="timeline_item timeline_1 blue">
                                            <div class="timeline_text">
                                                <h4>Registered: RA000170</h4>
                                                <p>Central Business Register (CVR),<br />in <?php echo $row['country']?>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="timeline_item timeline_2 blue">
                                            <div class="timeline_text">
                                                <h4>Registered as 32347037</h4>
                                                <p><?php echo $row['name'];?> <br /></p>
                                            </div>
                                        </div>
                                        <div class="timeline_item timeline_3 orange">
                                            <div class="timeline_text">
                                                <h4>Category</h4>
                                                <p>Loans and General Credit services</p>
                                            </div>
                                        </div>
                                        <div class="timeline_item timeline_4 orange">
                                            <div class="timeline_text">
                                                <h4>LEI Code</h4>
                                                <p>9845006553C1E694C078</p>
                                                <p>Legal Entity Identifier </p>
                                            </div>
                                        </div>

                                    </div>
                                    <div class="timeline_bottom_wrapper">
                                        <div class="timeline_bottom_wrap">

                                            <div class="timeline_bottom bottom_line_1 blue">
                                                <div class="line_text">
                                                    <h4>Entity Legal Form</h4>
                                                    <p>Anpartsselskab (da) <br />H8VP </p>
                                                </div>
                                            </div>
                                            <div class="timeline_bottom bottom_line_2 blue">
                                                <div class="line_text">
                                                    <h4>OpenCorporates ID</h4>
                                                    <p>dk/32347037 <br />Other financial service activities</p>
                                                </div>
                                            </div>
                                            <div class="timeline_bottom bottom_line_3 blue">
                                                <div class="line_text">
                                                    <h4>S&P Global Company ID</h4>
                                                    <p>607185456 </p>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="res_timeline">

                                    <div class="timeline_single blue">
                                        <div class="timeline_date">
                                            <h4>01</h4>
                                        </div>
                                        <div class="timeline_content">
                                            <p> Registered: RA000170 in <?php echo $row['country']?> </p>
                                        </div>
                                    </div>
                                    <div class="timeline_single blue">
                                        <div class="timeline_date">
                                        ...
                                        <div class="timeline_content">
                                            <p>Registered as 32347037 <?php echo $row['name'];?> </p>
                                        </div>
                                    </div>
                                    <div class="timeline_single blue">
                                        <div class="timeline_date">
                                        ...
                                        <div class="timeline_content">
                                            <p>Category: Loans and General Credit services</p>
                                        </div>
                                    </div>
                                    <div class="timeline_single blue">
                                        <div class="timeline_date">
                                        ...
                                        <div class="timeline_content">
                                            <p>LEI Code: 9845006553C1E694C078</p>
                                        </div>
                                    </div>
                                    <div class="timeline_single orange">
                                        <div class="timeline_date">
                                            <h4>05</h4>
                                        </div>
                                        <div class="timeline_content">
                                            <p>Entity Legal Form Anpartsselskab (da) <br />H8VP </p>
                                        </div>
                                    </div>
                                    <div class="timeline_single blue">
                                        <div class="timeline_date">
                                        ...
                                        <div class="timeline_content">
                                            <p>OpenCorporates ID dk/32347037 </p>
                                        </div>
                                    </div>
                                    <div class="timeline_single orange">
                                        <div class="timeline_date">
                                        ...
                                        <div class="timeline_content">
                                            <p>S&P Global Company ID 607185456</p>
                                        </div>
                                    </div>
            ...
            <!-- <section id="block_d12873c93cd838a13cb5dd3a8975fa72"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hiring-title">
                                    <h2>We’re hiring</h2>
                                    <p>We’re always growing and innovating– and always looking for the right people to
                                        grow along with us. <br><?php echo $row['name']; ?> associates receive
                            ...
                            <div class="hiring-wrapper">
                                ...
                                <div class="hire_info">
                                    <h4>Low deductible<br> health coverage</h4>
                                </div>
                                <div class="hire_info">
                                    <h4>Bonus programs &#038;<br> monthly incentives</h4>
                                </div>
                                <div class="hire_info">
                                    <h4>Comprehensive<br> paid training</h4>
                                </div>
                                <div class="hire_info">
                                    <h4>Generous vacation<br> &#038; sick leave</h4>
                                </div>
                                <div class="hire_info">
                                    <h4>401k plans</h4>
                                </div>
                            </div>
                            <div class="col-12 d-flex justify-content-center pt-5 added-awards pull-up">
                                <img fetchpriority="high" decoding="async" width="690" height="1128"
                                    src="../wp-content/uploads/2024/05/TWP-USA_2024.png"
                                    class="aw-img aw-img-2 size-medium alignleft m-0" alt="Awards"
                            ...
                            <div class="explore-btn text-center ">
                                <a href="https://us62e2.dayforcehcm.com/CandidatePortal/en-US/bru" target="_blank"
                                    class="common-btn btn_normal">See open positions</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="block_13d6ffb0b5a1813265ef6aa5acb8686f"
                class="block-testimonial-slider alignnone block-testimonial-slider has-font-color text-default">
                <div class="customers-review-area ">
                    <div class="container">
                            ...
                            <div class="testimonial_item">
                                <div class="review_card">
                                    <div class="customer_pro">
                                        <div class="r_name">
                                            <h4>Janett Guerrero Amaya</h4>
                                        </div>
                                        <div class="customer_pic">
                                            <span><img decoding="async" width="61" height="62"
                                                    src="../wp-content/uploads/2022/04/g.png" class="" alt="g" id="52"
                                                    loading="lazy" /></span>
                                        </div>
                                    </div>
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p>Great service Everything was quick and easy . Questions were asked through
                                            the phone and was approved immediately with no problem!</p>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="testimonial_item">
                                <div class="review_card">
                                    ...
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p>The staff there are great. They are friendly, courteous and very
                                            professional. It&#8217;s good to have a business around when you need a
                                            little extra to get you through until your payday. I have been a customer
                                            for awhile and would recommend <?php echo $row['name']; ?> to everyone who
                            ...
                            <div class="testimonial_item">
                                <div class="review_card">
                                    ...
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p>I had the most amazing experience with the loan process. I was in an out of
                                            the office in less than 30 minutes. Amy was such a pleasure to work with. I
                                            will definitely refer people!!!! Thank you Amy for a pleasant experience!!!!
                                        </p>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="testimonial_item">
                                <div class="review_card">
                                    ...
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p>Quick and easy friendly customer service , they put my loan on my debit card
                                            so I was in and out 🤙</p>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="testimonial_item">
                                <div class="review_card">
                                    ...
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p>They are patient and they have your best interest in mind</p>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="testimonial_item">
                                <div class="review_card">
                                    ...
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p>I was hesitant at first to go in and get a loan. Because I didn&#8217;t think
                                            that I would qualify for it. But thanks to the awesome ladies that work
                                            there ; they were able to help me out. Especially, when I really needed that
                                            money to help with my move . I give them 5 star&#8217;s. I would recommend
                                            to anyone to go with this loan company.</p>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="testimonial_item">
                                <div class="review_card">
                                    ...
                                    <div class="rating_icon">
                                        ...
                                        <p>
                                        <p>I had recently left another place to get some papers notarized and the
                                            previous place was not helpful at all. When I called she told me that she
                                            would do it for me and do it for free!!! Both the ladys were very sweet!!!
                                        </p>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="widget footer-nav footer-widget-1 widget_nav_menu nav_menu-2">
                                    ...
                                    <div class="menu-footer-column-1-container">
                                        <ul id="menu-footer-column-1" class="menu">
                                            <li id="menu-item-2993" class="menu-item current-menu-item"><a
                                                    href="index.php" aria-current="page">About</a></li>
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/about/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Dec 2024 23:45:27 GMT -->
